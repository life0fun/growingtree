...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15751 = 0;while(true){
var m_15752 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15752 == null))
{} else
{m_15752.call(null);
if((count_15751 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15753 = (count_15751 + 1);
count_15751 = G__15753;
continue;
}
} else
{}
