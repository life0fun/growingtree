...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15757 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15757 = (function (val,box,meta15758){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15757.cljs$lang$type = true;
cljs.core.async.impl.channels.t15757.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15757";
cljs.core.async.impl.channels.t15757.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t15757");
});
cljs.core.async.impl.channels.t15757.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15757.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15759){var self__ = this;
var _15759__$1 = this;return self__.meta15758;
});
cljs.core.async.impl.channels.t15757.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15759,meta15758__$1){var self__ = this;
var _15759__$1 = this;return (new cljs.core.async.impl.channels.t15757(self__.val,self__.box,meta15758__$1));
});
cljs.core.async.impl.channels.__GT_t15757 = (function __GT_t15757(val__$1,box__$1,meta15758){return (new cljs.core.async.impl.channels.t15757(val__$1,box__$1,meta15758));
});
}
return (new cljs.core.async.impl.channels.t15757(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_15760 = self__.takes.pop();if((taker_15760 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15760))
{var take_cb_15761 = cljs.core.async.impl.protocols.commit.call(null,taker_15760);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15761,taker_15760){
return (function (){return take_cb_15761.call(null,null);
});})(take_cb_15761,taker_15760))
);
} else
{}
{
