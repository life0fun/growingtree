...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_15716 = 0;while(true){
if((i_15716 < arr.length))
{(arr[i_15716] = null);
{
...
{var i_15723 = (self__.level + 1);while(true){
if((i_15723 <= (new_level + 1)))
{(update[i_15723] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15725 = 0;while(true){
if((i_15725 <= self__.level))
{var links_15726 = (update[i_15725]).forward;if(((links_15726[i_15725]) === x__$1))
{(links_15726[i_15725] = (x__$1.forward[i_15725]));
{
