...
growingtree_app.datetime.date_in_ms = (function date_in_ms(date){var vec__12025 = cljs.core.map.call(null,parseInt,cljs.core.name.call(null,date).split(/-/));var y = cljs.core.nth.call(null,vec__12025,0,null);var m = cljs.core.nth.call(null,vec__12025,1,null);var d = cljs.core.nth.call(null,vec__12025,2,null);return (new Date(Date.UTC(y,(m - 1),(d - 1),0,0,0))).getTime();
});
