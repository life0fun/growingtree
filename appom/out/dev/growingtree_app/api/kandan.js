...
growingtree_app.api.kandan.handle_activity = (function handle_activity(data){var data__$1 = cljs.core.js__GT_clj.call(null,data,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",4191781672));var event = new cljs.core.Keyword(null,"event","event",1110795788).cljs$core$IFn$_invoke$arity$1(data__$1);var vec__8869 = cljs.core.map.call(null,cljs.core.keyword,clojure.string.split.call(null,event,/#/));var entity_name = cljs.core.nth.call(null,vec__8869,0,null);var event_name = cljs.core.nth.call(null,vec__8869,1,null);return growingtree_app.api.kandan.process_event_BANG_.call(null,entity_name,event_name,data__$1);
});
growingtree_app.api.kandan.make_client = (function make_client(auth_token,end_point){var client = (new Faye.Client(end_point));var auth_extension = (function (){var obj8874 = {"outgoing":((function (client){
...
})();var G__8875 = client;G__8875.disable("websocket");
G__8875.addExtension(auth_extension);
G__8875.bind("transport:down",(function (){return growingtree_app.utils.mprint.call(null,"Connection to Kandan server is down");
}));
G__8875.bind("transport:up",(function (){return growingtree_app.utils.mprint.call(null,"Connection to Kandan server is up");
}));
G__8875.subscribe("/app/activities",growingtree_app.api.kandan.handle_activity);
return G__8875;
});
...
growingtree_app.api.kandan.save = (function save(api_key,obj){return growingtree_app.api.kandan.callbacks.post_activity_BANG_.call(null,api_key,cljs.core.js__GT_clj.call(null,obj),(function (p1__8876_SHARP_){return growingtree_app.utils.mprint.call(null,"Save Activity Result: ",p1__8876_SHARP_);
}));
});
