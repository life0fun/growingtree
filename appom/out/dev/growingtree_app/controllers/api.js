...
cljs.core._add_method.call(null,growingtree_app.controllers.api.api_event,new cljs.core.Keyword(null,"channel-activity-received","channel-activity-received",3517943815),(function (target,message,activity,state){var message_limit = cljs.core.get_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",2448535445),new cljs.core.Keyword(null,"message-limit","message-limit",2656236007)], null));return growingtree_app.controllers.api.drop_old_activity_from_channel.call(null,growingtree_app.controllers.api.append_activity_to_channel.call(null,state,new cljs.core.Keyword(null,"channel-id","channel-id",3378014615).cljs$core$IFn$_invoke$arity$1(activity),activity),new cljs.core.Keyword(null,"channel-id","channel-id",3378014615).cljs$core$IFn$_invoke$arity$1(activity),message_limit);
}));
