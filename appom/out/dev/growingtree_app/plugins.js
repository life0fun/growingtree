...
growingtree_app.plugins.mentions = (function mentions(activity_pieces,current_user_email,users,settings,author){return cljs.core.map.call(null,(function (piece){var vec__12035 = cljs.core.re_find.call(null,/(.*)@(\w+)(.*)/,piece);var _ = cljs.core.nth.call(null,vec__12035,0,null);var pre = cljs.core.nth.call(null,vec__12035,1,null);var username = cljs.core.nth.call(null,vec__12035,2,null);var post = cljs.core.nth.call(null,vec__12035,3,null);var temp__4090__auto__ = (function (){var and__3431__auto__ = typeof piece === 'string';if(and__3431__auto__)
...
growingtree_app.plugins.slash_play = (function slash_play(activity_pieces){var vec__12037 = activity_pieces;var command = cljs.core.nth.call(null,vec__12037,0,null);var url = cljs.core.nth.call(null,vec__12037,1,null);var rest = cljs.core.nthnext.call(null,vec__12037,2);if(cljs.core._EQ_.call(null,command,"/play"))
...
{var vec__12039 = temp__4090__auto__;var _ = cljs.core.nth.call(null,vec__12039,0,null);var pre = cljs.core.nth.call(null,vec__12039,1,null);var r = cljs.core.nth.call(null,vec__12039,2,null);var g = cljs.core.nth.call(null,vec__12039,3,null);var b = cljs.core.nth.call(null,vec__12039,4,null);var post = cljs.core.nth.call(null,vec__12039,5,null);return cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,post),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.color-preview","span.color-preview",4358700844),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",1123684643),{"background-color": [cljs.core.str("rgb("),cljs.core.str(r),cljs.core.str(","),cljs.core.str(g),cljs.core.str(","),cljs.core.str(b),cljs.core.str(")")].join('')}], null)], null)),pre);
} else
{return piece;
}
}),activity_pieces);
...
{var vec__12041 = temp__4090__auto__;var _ = cljs.core.nth.call(null,vec__12041,0,null);var pre = cljs.core.nth.call(null,vec__12041,1,null);var hex = cljs.core.nth.call(null,vec__12041,2,null);var post = cljs.core.nth.call(null,vec__12041,3,null);return cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,post),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.color-preview","span.color-preview",4358700844),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",1123684643),{"background-color": [cljs.core.str("#"),cljs.core.str(hex)].join('')}], null)], null)),pre);
} else
{return piece;
}
}),activity_pieces);
