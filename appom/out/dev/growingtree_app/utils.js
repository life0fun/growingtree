...
mprint.cljs$lang$applyTo = (function (arglist__12094){
var message = cljs.core.seq(arglist__12094);
...
})();var container = (function (){var G__12096 = (new goog.crypt.Md5());G__12096.update(email__$1);
return G__12096;
...
var ajax__delegate = function (url,method,data_string,success,p__12098){var vec__12100 = p__12098;var error = cljs.core.nth.call(null,vec__12100,0,null);var headers = cljs.core.nth.call(null,vec__12100,1,null);var request = (new goog.net.XhrIo());var d = (new goog.async.Deferred());var listener_id = goog.events.listen(request,goog.net.EventType.COMPLETE,((function (request,d){
...
{d.addCallback((function (p1__12097_SHARP_){return success.call(null,cljs.core.js__GT_clj.call(null,p1__12097_SHARP_,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",4191781672),true));
}));
} else
{}
...
var p__12098 = null;if (arguments.length > 4) {
  p__12098 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return ajax__delegate.call(this,url,method,data_string,success,p__12098);};
ajax.cljs$lang$maxFixedArity = 4;
ajax.cljs$lang$applyTo = (function (arglist__12101){
var url = cljs.core.first(arglist__12101);
arglist__12101 = cljs.core.next(arglist__12101);
var method = cljs.core.first(arglist__12101);
arglist__12101 = cljs.core.next(arglist__12101);
var data_string = cljs.core.first(arglist__12101);
arglist__12101 = cljs.core.next(arglist__12101);
var success = cljs.core.first(arglist__12101);
var p__12098 = cljs.core.rest(arglist__12101);
return ajax__delegate(url,method,data_string,success,p__12098);
});
