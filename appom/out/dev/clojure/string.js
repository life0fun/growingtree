...
{{
var G__13147 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13147;
continue;
}
} else
...
{var pred__13151 = cljs.core._EQ_;var expr__13152 = limit;if(cljs.core.truth_(pred__13151.call(null,1,expr__13152)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13151.call(null,2,expr__13152)))
...
{var ch = s.charAt(index);var temp__4090__auto___13158 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13158))
{var replacement_13159 = temp__4090__auto___13158;buffer.append([cljs.core.str(replacement_13159)].join(''));
} else
{buffer.append(ch);
}
{
var G__13160 = (index + 1);
index = G__13160;
continue;
}
}
