...
sablono.util.ToString = (function (){var obj16992 = {};return obj16992;
})();
...
sablono.util.ToURI = (function (){var obj16994 = {};return obj16994;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__16995){
var xs = cljs.core.seq(arglist__16995);
...
{var vec__16997 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__16997,0,null);var words = cljs.core.nthnext.call(null,vec__16997,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__16998_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__16998_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__16998_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__16998_SHARP_))
{return p1__16998_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__16999){
var maps = cljs.core.seq(arglist__16999);
...
*/
sablono.util.normalize_element = (function normalize_element(p__17000){var vec__17003 = p__17000;var tag = cljs.core.nth.call(null,vec__17003,0,null);var content = cljs.core.nthnext.call(null,vec__17003,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__17004 = cljs.core.re_matches.call(null,sablono.util.re_tag,cljs.core.name.call(null,tag));var _ = cljs.core.nth.call(null,vec__17004,0,null);var tag__$1 = cljs.core.nth.call(null,vec__17004,1,null);var id = cljs.core.nth.call(null,vec__17004,2,null);var class$ = cljs.core.nth.call(null,vec__17004,3,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),(cljs.core.truth_(class$)?clojure.string.split.call(null,class$,/\./):null)], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
