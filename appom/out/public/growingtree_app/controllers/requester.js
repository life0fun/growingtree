...
growingtree_app.controllers.requester.sendable_message_QMARK_ = (function sendable_message_QMARK_(message){var vec__11803 = clojure.string.split.call(null,message,/ |\n/);var command = cljs.core.nth.call(null,vec__11803,(0),null);var _ = cljs.core.nthnext.call(null,vec__11803,(1));if(cljs.core.truth_((function (){var or__3543__auto__ = cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([command], true),growingtree_app.controllers.requester.local_only_commands);if(cljs.core.truth_(or__3543__auto__))
...
cljs.core._add_method.call(null,growingtree_app.controllers.requester.request,new cljs.core.Keyword(null,"playlist-entry-played","playlist-entry-played",1138783655),(function (target,message,p__11805,previous_state,current_state){var vec__11806 = p__11805;var order = cljs.core.nth.call(null,vec__11806,(0),null);var channel_id = cljs.core.nth.call(null,vec__11806,(1),null);var controls_ch = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"controls","controls",1340701452)], null));var playlist = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",1132759174),channel_id,new cljs.core.Keyword(null,"player","player",-97687400),new cljs.core.Keyword(null,"playlist","playlist",1952276871)], null));var entry = growingtree_app.useful.ffilter.call(null,((function (controls_ch,playlist,vec__11806,order,channel_id){
return (function (p1__11804_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(p1__11804_SHARP_),order);
});})(controls_ch,playlist,vec__11806,order,channel_id))
...
return (function (){var seq__11811 = cljs.core.seq.call(null,players);var chunk__11812 = null;var count__11813 = (0);var i__11814 = (0);while(true){
if((i__11814 < count__11813))
{var player = cljs.core._nth.call(null,chunk__11812,i__11814);player.muted = true;
{
...
{var temp__4126__auto__ = cljs.core.seq.call(null,seq__11811);if(temp__4126__auto__)
{var seq__11811__$1 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__11811__$1))
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__11811__$1);{
var G__11819 = cljs.core.chunk_rest.call(null,seq__11811__$1);
var G__11820 = c__4299__auto__;
var G__11821 = cljs.core.count.call(null,c__4299__auto__);
var G__11822 = (0);
seq__11811 = G__11819;
...
{var player = cljs.core.first.call(null,seq__11811__$1);player.muted = true;
{
...
return (function (){var seq__11827 = cljs.core.seq.call(null,players);var chunk__11828 = null;var count__11829 = (0);var i__11830 = (0);while(true){
if((i__11830 < count__11829))
{var player = cljs.core._nth.call(null,chunk__11828,i__11830);player.muted = false;
{
...
{var temp__4126__auto__ = cljs.core.seq.call(null,seq__11827);if(temp__4126__auto__)
{var seq__11827__$1 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__11827__$1))
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__11827__$1);{
var G__11835 = cljs.core.chunk_rest.call(null,seq__11827__$1);
var G__11836 = c__4299__auto__;
var G__11837 = cljs.core.count.call(null,c__4299__auto__);
var G__11838 = (0);
seq__11827 = G__11835;
...
{var player = cljs.core.first.call(null,seq__11827__$1);player.muted = false;
{
...
cljs.core._add_method.call(null,growingtree_app.controllers.requester.request,new cljs.core.Keyword(null,"current-user-mentioned","current-user-mentioned",134481480),(function (target,message,p__11843,previous_state,current_state){var vec__11844 = p__11843;var activity = cljs.core.nth.call(null,vec__11844,(0),null);var url = cljs.core.nth.call(null,vec__11844,(1),null);var player = dommy.template.__GT_node_like.call(null,target).querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(".audio-player.sfx.audio-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"channel-id","channel-id",138191095).cljs$core$IFn$_invoke$arity$1(activity)))], null)));return setTimeout(((function (player,vec__11844,activity,url){
return (function (){return player.play();
});})(player,vec__11844,activity,url))
,(35));
}));
cljs.core._add_method.call(null,growingtree_app.controllers.requester.request,new cljs.core.Keyword(null,"user-logged-out","user-logged-out",-1569726039),(function (target,message,p__11845,previous_state,current_state){var vec__11846 = p__11845;var activity = cljs.core.nth.call(null,vec__11846,(0),null);var url = cljs.core.nth.call(null,vec__11846,(1),null);return growingtree_app.utils.mprint.call(null,"Log the user out somehow");
}));
cljs.core._add_method.call(null,growingtree_app.controllers.requester.request,new cljs.core.Keyword(null,"search-field-focused","search-field-focused",1388495290),(function (target,message,p__11847,previous_state,current_state){var vec__11848 = p__11847;var activity = cljs.core.nth.call(null,vec__11848,(0),null);var url = cljs.core.nth.call(null,vec__11848,(1),null);var temp__4126__auto__ = document.querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [target,new cljs.core.Keyword(null,"input.query","input.query",1777106866)], null)));if(cljs.core.truth_(temp__4126__auto__))
{var search_field = temp__4126__auto__;return window.setTimeout(((function (search_field,temp__4126__auto__,vec__11848,activity,url){
...
});})(search_field,temp__4126__auto__,vec__11848,activity,url))
,(20));
} else
{return null;
}
