...
growingtree_app.controllers.requester.sendable_message_QMARK_ = (function sendable_message_QMARK_(message){var vec__11781 = clojure.string.split.call(null,message,/ |\n/);var command = cljs.core.nth.call(null,vec__11781,(0),null);var _ = cljs.core.nthnext.call(null,vec__11781,(1));if(cljs.core.truth_((function (){var or__3543__auto__ = cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([command], true),growingtree_app.controllers.requester.local_only_commands);if(cljs.core.truth_(or__3543__auto__))
...
cljs.core._add_method.call(null,growingtree_app.controllers.requester.request,new cljs.core.Keyword(null,"playlist-entry-played","playlist-entry-played",1138783655),(function (target,message,p__11783,previous_state,current_state){var vec__11784 = p__11783;var order = cljs.core.nth.call(null,vec__11784,(0),null);var channel_id = cljs.core.nth.call(null,vec__11784,(1),null);var controls_ch = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"controls","controls",1340701452)], null));var playlist = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",1132759174),channel_id,new cljs.core.Keyword(null,"player","player",-97687400),new cljs.core.Keyword(null,"playlist","playlist",1952276871)], null));var entry = growingtree_app.useful.ffilter.call(null,((function (controls_ch,playlist,vec__11784,order,channel_id){
return (function (p1__11782_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(p1__11782_SHARP_),order);
});})(controls_ch,playlist,vec__11784,order,channel_id))
...
return (function (){var seq__11789 = cljs.core.seq.call(null,players);var chunk__11790 = null;var count__11791 = (0);var i__11792 = (0);while(true){
if((i__11792 < count__11791))
{var player = cljs.core._nth.call(null,chunk__11790,i__11792);player.muted = true;
{
...
{var temp__4126__auto__ = cljs.core.seq.call(null,seq__11789);if(temp__4126__auto__)
{var seq__11789__$1 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__11789__$1))
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__11789__$1);{
var G__11797 = cljs.core.chunk_rest.call(null,seq__11789__$1);
var G__11798 = c__4299__auto__;
var G__11799 = cljs.core.count.call(null,c__4299__auto__);
var G__11800 = (0);
seq__11789 = G__11797;
...
{var player = cljs.core.first.call(null,seq__11789__$1);player.muted = true;
{
...
return (function (){var seq__11805 = cljs.core.seq.call(null,players);var chunk__11806 = null;var count__11807 = (0);var i__11808 = (0);while(true){
if((i__11808 < count__11807))
{var player = cljs.core._nth.call(null,chunk__11806,i__11808);player.muted = false;
{
...
{var player = cljs.core.first.call(null,seq__11805__$1);player.muted = false;
{
...
cljs.core._add_method.call(null,growingtree_app.controllers.requester.request,new cljs.core.Keyword(null,"current-user-mentioned","current-user-mentioned",134481480),(function (target,message,p__11821,previous_state,current_state){var vec__11822 = p__11821;var activity = cljs.core.nth.call(null,vec__11822,(0),null);var url = cljs.core.nth.call(null,vec__11822,(1),null);var player = dommy.template.__GT_node_like.call(null,target).querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(".audio-player.sfx.audio-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"channel-id","channel-id",138191095).cljs$core$IFn$_invoke$arity$1(activity)))], null)));return setTimeout(((function (player,vec__11822,activity,url){
return (function (){return player.play();
});})(player,vec__11822,activity,url))
,(35));
}));
cljs.core._add_method.call(null,growingtree_app.controllers.requester.request,new cljs.core.Keyword(null,"user-logged-out","user-logged-out",-1569726039),(function (target,message,p__11823,previous_state,current_state){var vec__11824 = p__11823;var activity = cljs.core.nth.call(null,vec__11824,(0),null);var url = cljs.core.nth.call(null,vec__11824,(1),null);return growingtree_app.utils.mprint.call(null,"Log the user out somehow");
}));
cljs.core._add_method.call(null,growingtree_app.controllers.requester.request,new cljs.core.Keyword(null,"search-field-focused","search-field-focused",1388495290),(function (target,message,p__11825,previous_state,current_state){var vec__11826 = p__11825;var activity = cljs.core.nth.call(null,vec__11826,(0),null);var url = cljs.core.nth.call(null,vec__11826,(1),null);var temp__4126__auto__ = document.querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [target,new cljs.core.Keyword(null,"input.query","input.query",1777106866)], null)));if(cljs.core.truth_(temp__4126__auto__))
{var search_field = temp__4126__auto__;return window.setTimeout(((function (search_field,temp__4126__auto__,vec__11826,activity,url){
...
});})(search_field,temp__4126__auto__,vec__11826,activity,url))
,(20));
} else
{return null;
}
