...
growingtree_app.controllers.post_controls.sendable_message_QMARK_ = (function sendable_message_QMARK_(message){var vec__11717 = clojure.string.split.call(null,message,/ |\n/);var command = cljs.core.nth.call(null,vec__11717,(0),null);var _ = cljs.core.nthnext.call(null,vec__11717,(1));if(cljs.core.truth_((function (){var or__3543__auto__ = cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([command], true),growingtree_app.controllers.post_controls.local_only_commands);if(cljs.core.truth_(or__3543__auto__))
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"playlist-entry-played","playlist-entry-played",1138783655),(function (target,message,p__11719,previous_state,current_state){var vec__11720 = p__11719;var order = cljs.core.nth.call(null,vec__11720,(0),null);var channel_id = cljs.core.nth.call(null,vec__11720,(1),null);var controls_ch = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"controls","controls",1340701452)], null));var playlist = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",1132759174),channel_id,new cljs.core.Keyword(null,"player","player",-97687400),new cljs.core.Keyword(null,"playlist","playlist",1952276871)], null));var entry = growingtree_app.useful.ffilter.call(null,((function (controls_ch,playlist,vec__11720,order,channel_id){
return (function (p1__11718_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(p1__11718_SHARP_),order);
});})(controls_ch,playlist,vec__11720,order,channel_id))
...
return (function (){var seq__11725 = cljs.core.seq.call(null,players);var chunk__11726 = null;var count__11727 = (0);var i__11728 = (0);while(true){
if((i__11728 < count__11727))
{var player = cljs.core._nth.call(null,chunk__11726,i__11728);player.muted = true;
{
var G__11729 = seq__11725;
var G__11730 = chunk__11726;
var G__11731 = count__11727;
var G__11732 = (i__11728 + (1));
seq__11725 = G__11729;
chunk__11726 = G__11730;
count__11727 = G__11731;
i__11728 = G__11732;
continue;
}
} else
{var temp__4126__auto__ = cljs.core.seq.call(null,seq__11725);if(temp__4126__auto__)
{var seq__11725__$1 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__11725__$1))
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__11725__$1);{
var G__11733 = cljs.core.chunk_rest.call(null,seq__11725__$1);
var G__11734 = c__4299__auto__;
var G__11735 = cljs.core.count.call(null,c__4299__auto__);
var G__11736 = (0);
seq__11725 = G__11733;
chunk__11726 = G__11734;
count__11727 = G__11735;
i__11728 = G__11736;
continue;
}
} else
{var player = cljs.core.first.call(null,seq__11725__$1);player.muted = true;
{
var G__11737 = cljs.core.next.call(null,seq__11725__$1);
var G__11738 = null;
var G__11739 = (0);
var G__11740 = (0);
seq__11725 = G__11737;
chunk__11726 = G__11738;
count__11727 = G__11739;
i__11728 = G__11740;
continue;
}
}
...
return (function (){var seq__11741 = cljs.core.seq.call(null,players);var chunk__11742 = null;var count__11743 = (0);var i__11744 = (0);while(true){
if((i__11744 < count__11743))
{var player = cljs.core._nth.call(null,chunk__11742,i__11744);player.muted = false;
{
var G__11745 = seq__11741;
var G__11746 = chunk__11742;
var G__11747 = count__11743;
var G__11748 = (i__11744 + (1));
seq__11741 = G__11745;
chunk__11742 = G__11746;
count__11743 = G__11747;
i__11744 = G__11748;
continue;
}
} else
{var temp__4126__auto__ = cljs.core.seq.call(null,seq__11741);if(temp__4126__auto__)
{var seq__11741__$1 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__11741__$1))
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__11741__$1);{
var G__11749 = cljs.core.chunk_rest.call(null,seq__11741__$1);
var G__11750 = c__4299__auto__;
var G__11751 = cljs.core.count.call(null,c__4299__auto__);
var G__11752 = (0);
seq__11741 = G__11749;
chunk__11742 = G__11750;
count__11743 = G__11751;
i__11744 = G__11752;
continue;
}
} else
{var player = cljs.core.first.call(null,seq__11741__$1);player.muted = false;
{
var G__11753 = cljs.core.next.call(null,seq__11741__$1);
var G__11754 = null;
var G__11755 = (0);
var G__11756 = (0);
seq__11741 = G__11753;
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"current-user-mentioned","current-user-mentioned",134481480),(function (target,message,p__11757,previous_state,current_state){var vec__11758 = p__11757;var activity = cljs.core.nth.call(null,vec__11758,(0),null);var url = cljs.core.nth.call(null,vec__11758,(1),null);var player = dommy.template.__GT_node_like.call(null,target).querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(".audio-player.sfx.audio-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"channel-id","channel-id",138191095).cljs$core$IFn$_invoke$arity$1(activity)))], null)));return setTimeout(((function (player,vec__11758,activity,url){
return (function (){return player.play();
});})(player,vec__11758,activity,url))
,(35));
}));
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"user-logged-out","user-logged-out",-1569726039),(function (target,message,p__11759,previous_state,current_state){var vec__11760 = p__11759;var activity = cljs.core.nth.call(null,vec__11760,(0),null);var url = cljs.core.nth.call(null,vec__11760,(1),null);return growingtree_app.utils.mprint.call(null,"Log the user out somehow");
}));
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"search-field-focused","search-field-focused",1388495290),(function (target,message,p__11761,previous_state,current_state){var vec__11762 = p__11761;var activity = cljs.core.nth.call(null,vec__11762,(0),null);var url = cljs.core.nth.call(null,vec__11762,(1),null);var temp__4126__auto__ = document.querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [target,new cljs.core.Keyword(null,"input.query","input.query",1777106866)], null)));if(cljs.core.truth_(temp__4126__auto__))
{var search_field = temp__4126__auto__;return window.setTimeout(((function (search_field,temp__4126__auto__,vec__11762,activity,url){
...
});})(search_field,temp__4126__auto__,vec__11762,activity,url))
,(20));
} else
{return null;
}
