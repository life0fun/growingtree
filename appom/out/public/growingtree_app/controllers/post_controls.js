...
growingtree_app.controllers.post_controls.sendable_message_QMARK_ = (function sendable_message_QMARK_(message){var vec__11286 = clojure.string.split.call(null,message,/ |\n/);var command = cljs.core.nth.call(null,vec__11286,0,null);var _ = cljs.core.nthnext.call(null,vec__11286,1);if(cljs.core.truth_((function (){var or__3443__auto__ = cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([command], true),growingtree_app.controllers.post_controls.local_only_commands);if(cljs.core.truth_(or__3443__auto__))
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"playlist-entry-played","playlist-entry-played",1677366299),(function (target,message,p__11288,previous_state,current_state){var vec__11289 = p__11288;var order = cljs.core.nth.call(null,vec__11289,0,null);var channel_id = cljs.core.nth.call(null,vec__11289,1,null);var controls_ch = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var playlist = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",2446530370),channel_id,new cljs.core.Keyword(null,"player","player",4323118675),new cljs.core.Keyword(null,"playlist","playlist",2893378884)], null));var entry = growingtree_app.useful.ffilter.call(null,((function (controls_ch,playlist){
return (function (p1__11287_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"order","order",1119910592).cljs$core$IFn$_invoke$arity$1(p1__11287_SHARP_),order);
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"user-message-submitted","user-message-submitted",1304334501),(function (target,message,args,previous_state,current_state){var channel = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",2446530370),new cljs.core.Keyword(null,"selected-channel","selected-channel",2473753411).cljs$core$IFn$_invoke$arity$1(current_state)], null));var user_message = cljs.core.get_in.call(null,previous_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",2448535445),new cljs.core.Keyword(null,"forms","forms",1111523233),new cljs.core.Keyword(null,"user-message","user-message",2253309815),new cljs.core.Keyword(null,"value","value",1125876963)], null));var content = cljs.core.get_in.call(null,previous_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",2448535445),new cljs.core.Keyword(null,"forms","forms",1111523233),new cljs.core.Keyword(null,"user-message","user-message",2253309815),new cljs.core.Keyword(null,"value","value",1125876963)], null));var user = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"current-user-email","current-user-email",4091392864).cljs$core$IFn$_invoke$arity$1(current_state)], null));var channel__$1 = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",2446530370),new cljs.core.Keyword(null,"selected-channel","selected-channel",2473753411).cljs$core$IFn$_invoke$arity$1(current_state)], null));var api_key = new cljs.core.Keyword(null,"api-key","api-key",4507296670).cljs$core$IFn$_invoke$arity$1(user);var activity = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"content","content",1965434859),content,new cljs.core.Keyword(null,"author","author",3902543101),new cljs.core.Keyword(null,"email","email",1110523662).cljs$core$IFn$_invoke$arity$1(user),new cljs.core.Keyword(null,"created_at","created_at",2383584348),(new Date()),new cljs.core.Keyword(null,"channel-id","channel-id",3378014615),new cljs.core.Keyword(null,"id","id",1013907597).cljs$core$IFn$_invoke$arity$1(channel__$1)], null);var temp__4092__auto___11292 = dommy.template.__GT_node_like.call(null,target).querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,".chat-input",".chat-input",1495609141)], null)));if(cljs.core.truth_(temp__4092__auto___11292))
{var input_11293 = temp__4092__auto___11292;dommy.core.set_value_BANG_.call(null,input_11293,"");
} else
{}
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"audio-player-muted","audio-player-muted",4718730120),(function (target,message,args,previous_state,current_state){var players = dommy.utils.__GT_Array.call(null,dommy.template.__GT_node_like.call(null,target).getElementsByClassName("audio-player"));return setTimeout((function (){var seq__11294 = cljs.core.seq.call(null,players);var chunk__11295 = null;var count__11296 = 0;var i__11297 = 0;while(true){
if((i__11297 < count__11296))
{var player = cljs.core._nth.call(null,chunk__11295,i__11297);player.muted = true;
{
var G__11298 = seq__11294;
var G__11299 = chunk__11295;
var G__11300 = count__11296;
var G__11301 = (i__11297 + 1);
seq__11294 = G__11298;
chunk__11295 = G__11299;
count__11296 = G__11300;
i__11297 = G__11301;
continue;
}
} else
...
{var c__4191__auto__ = cljs.core.chunk_first.call(null,seq__11294__$1);{
var G__11302 = cljs.core.chunk_rest.call(null,seq__11294__$1);
var G__11303 = c__4191__auto__;
var G__11304 = cljs.core.count.call(null,c__4191__auto__);
var G__11305 = 0;
seq__11294 = G__11302;
chunk__11295 = G__11303;
count__11296 = G__11304;
i__11297 = G__11305;
continue;
}
} else
{var player = cljs.core.first.call(null,seq__11294__$1);player.muted = true;
{
var G__11306 = cljs.core.next.call(null,seq__11294__$1);
var G__11307 = null;
var G__11308 = 0;
var G__11309 = 0;
seq__11294 = G__11306;
chunk__11295 = G__11307;
count__11296 = G__11308;
i__11297 = G__11309;
continue;
}
}
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"audio-player-unmuted","audio-player-unmuted",3422373327),(function (target,message,args,previous_state,current_state){var players = dommy.utils.__GT_Array.call(null,dommy.template.__GT_node_like.call(null,target).getElementsByClassName("audio-player"));return setTimeout((function (){var seq__11310 = cljs.core.seq.call(null,players);var chunk__11311 = null;var count__11312 = 0;var i__11313 = 0;while(true){
if((i__11313 < count__11312))
{var player = cljs.core._nth.call(null,chunk__11311,i__11313);player.muted = false;
{
var G__11314 = seq__11310;
var G__11315 = chunk__11311;
var G__11316 = count__11312;
var G__11317 = (i__11313 + 1);
seq__11310 = G__11314;
chunk__11311 = G__11315;
count__11312 = G__11316;
i__11313 = G__11317;
continue;
}
} else
{var temp__4092__auto__ = cljs.core.seq.call(null,seq__11310);if(temp__4092__auto__)
{var seq__11310__$1 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__11310__$1))
{var c__4191__auto__ = cljs.core.chunk_first.call(null,seq__11310__$1);{
var G__11318 = cljs.core.chunk_rest.call(null,seq__11310__$1);
var G__11319 = c__4191__auto__;
var G__11320 = cljs.core.count.call(null,c__4191__auto__);
var G__11321 = 0;
seq__11310 = G__11318;
...
{var player = cljs.core.first.call(null,seq__11310__$1);player.muted = false;
{
var G__11322 = cljs.core.next.call(null,seq__11310__$1);
var G__11323 = null;
var G__11324 = 0;
var G__11325 = 0;
seq__11310 = G__11322;
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"current-user-mentioned","current-user-mentioned",1125795533),(function (target,message,p__11326,previous_state,current_state){var vec__11327 = p__11326;var activity = cljs.core.nth.call(null,vec__11327,0,null);var url = cljs.core.nth.call(null,vec__11327,1,null);var player = dommy.template.__GT_node_like.call(null,target).querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str(".audio-player.sfx.audio-"),cljs.core.str(new cljs.core.Keyword(null,"channel-id","channel-id",3378014615).cljs$core$IFn$_invoke$arity$1(activity))].join('')], null)));return setTimeout((function (){return player.play();
}),35);
}));
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"user-logged-out","user-logged-out",2519482167),(function (target,message,p__11328,previous_state,current_state){var vec__11329 = p__11328;var activity = cljs.core.nth.call(null,vec__11329,0,null);var url = cljs.core.nth.call(null,vec__11329,1,null);return growingtree_app.utils.mprint.call(null,"Log the user out somehow");
}));
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"search-field-focused","search-field-focused",1194736049),(function (target,message,p__11330,previous_state,current_state){var vec__11331 = p__11330;var activity = cljs.core.nth.call(null,vec__11331,0,null);var url = cljs.core.nth.call(null,vec__11331,1,null);var temp__4092__auto__ = document.querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [target,new cljs.core.Keyword(null,"input.query","input.query",3940929814)], null)));if(cljs.core.truth_(temp__4092__auto__))
