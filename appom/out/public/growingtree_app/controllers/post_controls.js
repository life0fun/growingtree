...
growingtree_app.controllers.post_controls.sendable_message_QMARK_ = (function sendable_message_QMARK_(message){var vec__11753 = clojure.string.split.call(null,message,/ |\n/);var command = cljs.core.nth.call(null,vec__11753,(0),null);var _ = cljs.core.nthnext.call(null,vec__11753,(1));if(cljs.core.truth_((function (){var or__3543__auto__ = cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([command], true),growingtree_app.controllers.post_controls.local_only_commands);if(cljs.core.truth_(or__3543__auto__))
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"search-thing","search-thing",-189284446),(function (target,msg_type,nav_path,previous_state,current_state){console.log(cljs.core.pr_str.call(null,"post ajax search-thing nav-path ",nav_path));
growingtree_app.utils.set_window_href_BANG_.call(null,growingtree_app.routes.v1_all_things.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"thing-type","thing-type",15521235),cljs.core.name.call(null,cljs.core.get.call(null,nav_path,new cljs.core.Keyword(null,"search-thing","search-thing",-189284446)))], null)));
return growingtree_app.api.cljsajax.cljs_ajax.call(null,new cljs.core.Keyword(null,"search-thing","search-thing",-189284446),nav_path,cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"api","api",-899839580)], null)),cljs.core.get.call(null,nav_path,new cljs.core.Keyword(null,"details","details",1956795411)));
}));
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"playlist-entry-played","playlist-entry-played",1138783655),(function (target,message,p__11755,previous_state,current_state){var vec__11756 = p__11755;var order = cljs.core.nth.call(null,vec__11756,(0),null);var channel_id = cljs.core.nth.call(null,vec__11756,(1),null);var controls_ch = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"controls","controls",1340701452)], null));var playlist = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",1132759174),channel_id,new cljs.core.Keyword(null,"player","player",-97687400),new cljs.core.Keyword(null,"playlist","playlist",1952276871)], null));var entry = growingtree_app.useful.ffilter.call(null,((function (controls_ch,playlist,vec__11756,order,channel_id){
return (function (p1__11754_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(p1__11754_SHARP_),order);
});})(controls_ch,playlist,vec__11756,order,channel_id))
...
return (function (){var seq__11761 = cljs.core.seq.call(null,players);var chunk__11762 = null;var count__11763 = (0);var i__11764 = (0);while(true){
if((i__11764 < count__11763))
{var player = cljs.core._nth.call(null,chunk__11762,i__11764);player.muted = true;
{
var G__11765 = seq__11761;
var G__11766 = chunk__11762;
var G__11767 = count__11763;
var G__11768 = (i__11764 + (1));
seq__11761 = G__11765;
chunk__11762 = G__11766;
count__11763 = G__11767;
i__11764 = G__11768;
continue;
}
} else
...
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__11761__$1);{
var G__11769 = cljs.core.chunk_rest.call(null,seq__11761__$1);
var G__11770 = c__4299__auto__;
var G__11771 = cljs.core.count.call(null,c__4299__auto__);
var G__11772 = (0);
seq__11761 = G__11769;
...
{var player = cljs.core.first.call(null,seq__11761__$1);player.muted = true;
{
var G__11773 = cljs.core.next.call(null,seq__11761__$1);
var G__11774 = null;
var G__11775 = (0);
var G__11776 = (0);
seq__11761 = G__11773;
...
return (function (){var seq__11777 = cljs.core.seq.call(null,players);var chunk__11778 = null;var count__11779 = (0);var i__11780 = (0);while(true){
if((i__11780 < count__11779))
{var player = cljs.core._nth.call(null,chunk__11778,i__11780);player.muted = false;
{
...
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__11777__$1);{
var G__11785 = cljs.core.chunk_rest.call(null,seq__11777__$1);
var G__11786 = c__4299__auto__;
var G__11787 = cljs.core.count.call(null,c__4299__auto__);
var G__11788 = (0);
seq__11777 = G__11785;
...
{var player = cljs.core.first.call(null,seq__11777__$1);player.muted = false;
{
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"current-user-mentioned","current-user-mentioned",134481480),(function (target,message,p__11793,previous_state,current_state){var vec__11794 = p__11793;var activity = cljs.core.nth.call(null,vec__11794,(0),null);var url = cljs.core.nth.call(null,vec__11794,(1),null);var player = dommy.template.__GT_node_like.call(null,target).querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(".audio-player.sfx.audio-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"channel-id","channel-id",138191095).cljs$core$IFn$_invoke$arity$1(activity)))], null)));return setTimeout(((function (player,vec__11794,activity,url){
return (function (){return player.play();
});})(player,vec__11794,activity,url))
,(35));
}));
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"user-logged-out","user-logged-out",-1569726039),(function (target,message,p__11795,previous_state,current_state){var vec__11796 = p__11795;var activity = cljs.core.nth.call(null,vec__11796,(0),null);var url = cljs.core.nth.call(null,vec__11796,(1),null);return growingtree_app.utils.mprint.call(null,"Log the user out somehow");
}));
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"search-field-focused","search-field-focused",1388495290),(function (target,message,p__11797,previous_state,current_state){var vec__11798 = p__11797;var activity = cljs.core.nth.call(null,vec__11798,(0),null);var url = cljs.core.nth.call(null,vec__11798,(1),null);var temp__4126__auto__ = document.querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [target,new cljs.core.Keyword(null,"input.query","input.query",1777106866)], null)));if(cljs.core.truth_(temp__4126__auto__))
{var search_field = temp__4126__auto__;return window.setTimeout(((function (search_field,temp__4126__auto__,vec__11798,activity,url){
...
});})(search_field,temp__4126__auto__,vec__11798,activity,url))
,(20));
} else
{return null;
}
