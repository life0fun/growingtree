...
growingtree_app.controllers.post_controls.sendable_message_QMARK_ = (function sendable_message_QMARK_(message){var vec__11752 = clojure.string.split.call(null,message,/ |\n/);var command = cljs.core.nth.call(null,vec__11752,(0),null);var _ = cljs.core.nthnext.call(null,vec__11752,(1));if(cljs.core.truth_((function (){var or__3543__auto__ = cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([command], true),growingtree_app.controllers.post_controls.local_only_commands);if(cljs.core.truth_(or__3543__auto__))
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"playlist-entry-played","playlist-entry-played",1138783655),(function (target,message,p__11754,previous_state,current_state){var vec__11755 = p__11754;var order = cljs.core.nth.call(null,vec__11755,(0),null);var channel_id = cljs.core.nth.call(null,vec__11755,(1),null);var controls_ch = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"controls","controls",1340701452)], null));var playlist = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",1132759174),channel_id,new cljs.core.Keyword(null,"player","player",-97687400),new cljs.core.Keyword(null,"playlist","playlist",1952276871)], null));var entry = growingtree_app.useful.ffilter.call(null,((function (controls_ch,playlist,vec__11755,order,channel_id){
return (function (p1__11753_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(p1__11753_SHARP_),order);
});})(controls_ch,playlist,vec__11755,order,channel_id))
...
return (function (){var seq__11760 = cljs.core.seq.call(null,players);var chunk__11761 = null;var count__11762 = (0);var i__11763 = (0);while(true){
if((i__11763 < count__11762))
{var player = cljs.core._nth.call(null,chunk__11761,i__11763);player.muted = true;
{
var G__11764 = seq__11760;
var G__11765 = chunk__11761;
var G__11766 = count__11762;
var G__11767 = (i__11763 + (1));
seq__11760 = G__11764;
chunk__11761 = G__11765;
count__11762 = G__11766;
i__11763 = G__11767;
continue;
}
} else
{var temp__4126__auto__ = cljs.core.seq.call(null,seq__11760);if(temp__4126__auto__)
{var seq__11760__$1 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__11760__$1))
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__11760__$1);{
var G__11768 = cljs.core.chunk_rest.call(null,seq__11760__$1);
var G__11769 = c__4299__auto__;
var G__11770 = cljs.core.count.call(null,c__4299__auto__);
var G__11771 = (0);
seq__11760 = G__11768;
chunk__11761 = G__11769;
count__11762 = G__11770;
i__11763 = G__11771;
continue;
}
} else
{var player = cljs.core.first.call(null,seq__11760__$1);player.muted = true;
{
var G__11772 = cljs.core.next.call(null,seq__11760__$1);
var G__11773 = null;
var G__11774 = (0);
var G__11775 = (0);
seq__11760 = G__11772;
chunk__11761 = G__11773;
count__11762 = G__11774;
i__11763 = G__11775;
continue;
}
}
...
return (function (){var seq__11776 = cljs.core.seq.call(null,players);var chunk__11777 = null;var count__11778 = (0);var i__11779 = (0);while(true){
if((i__11779 < count__11778))
{var player = cljs.core._nth.call(null,chunk__11777,i__11779);player.muted = false;
{
...
{var temp__4126__auto__ = cljs.core.seq.call(null,seq__11776);if(temp__4126__auto__)
{var seq__11776__$1 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__11776__$1))
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__11776__$1);{
var G__11784 = cljs.core.chunk_rest.call(null,seq__11776__$1);
var G__11785 = c__4299__auto__;
var G__11786 = cljs.core.count.call(null,c__4299__auto__);
var G__11787 = (0);
seq__11776 = G__11784;
...
{var player = cljs.core.first.call(null,seq__11776__$1);player.muted = false;
{
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"current-user-mentioned","current-user-mentioned",134481480),(function (target,message,p__11792,previous_state,current_state){var vec__11793 = p__11792;var activity = cljs.core.nth.call(null,vec__11793,(0),null);var url = cljs.core.nth.call(null,vec__11793,(1),null);var player = dommy.template.__GT_node_like.call(null,target).querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(".audio-player.sfx.audio-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"channel-id","channel-id",138191095).cljs$core$IFn$_invoke$arity$1(activity)))], null)));return setTimeout(((function (player,vec__11793,activity,url){
return (function (){return player.play();
});})(player,vec__11793,activity,url))
,(35));
}));
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"user-logged-out","user-logged-out",-1569726039),(function (target,message,p__11794,previous_state,current_state){var vec__11795 = p__11794;var activity = cljs.core.nth.call(null,vec__11795,(0),null);var url = cljs.core.nth.call(null,vec__11795,(1),null);return growingtree_app.utils.mprint.call(null,"Log the user out somehow");
}));
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"search-field-focused","search-field-focused",1388495290),(function (target,message,p__11796,previous_state,current_state){var vec__11797 = p__11796;var activity = cljs.core.nth.call(null,vec__11797,(0),null);var url = cljs.core.nth.call(null,vec__11797,(1),null);var temp__4126__auto__ = document.querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [target,new cljs.core.Keyword(null,"input.query","input.query",1777106866)], null)));if(cljs.core.truth_(temp__4126__auto__))
{var search_field = temp__4126__auto__;return window.setTimeout(((function (search_field,temp__4126__auto__,vec__11797,activity,url){
...
});})(search_field,temp__4126__auto__,vec__11797,activity,url))
,(20));
} else
{return null;
}
