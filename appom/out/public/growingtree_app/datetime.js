...
growingtree_app.datetime.date_in_ms = (function date_in_ms(date){var vec__12336 = cljs.core.map.call(null,parseInt,cljs.core.name.call(null,date).split(/-/));var y = cljs.core.nth.call(null,vec__12336,0,null);var m = cljs.core.nth.call(null,vec__12336,1,null);var d = cljs.core.nth.call(null,vec__12336,2,null);return (new Date(Date.UTC(y,(m - 1),(d - 1),0,0,0))).getTime();
});
...
growingtree_app.datetime.time_ago = (function time_ago(time){var now = (new Date()).getTime();var ago = Math.floor(((now - time) / 1000));var interval = (((ago < growingtree_app.datetime.hour))?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"divisor","divisor",2688237584),growingtree_app.datetime.minute,new cljs.core.Keyword(null,"unit","unit",1017498870),"minute"], null):(((ago < growingtree_app.datetime.day))?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"divisor","divisor",2688237584),growingtree_app.datetime.hour,new cljs.core.Keyword(null,"unit","unit",1017498870),"hour"], null):(((ago < growingtree_app.datetime.month))?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"divisor","divisor",2688237584),growingtree_app.datetime.day,new cljs.core.Keyword(null,"unit","unit",1017498870),"day"], null):(((ago < growingtree_app.datetime.year))?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"divisor","divisor",2688237584),growingtree_app.datetime.month,new cljs.core.Keyword(null,"unit","unit",1017498870),"month"], null):((new cljs.core.Keyword(null,"else","else",1017020587))?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"divisor","divisor",2688237584),growingtree_app.datetime.year,new cljs.core.Keyword(null,"unit","unit",1017498870),"year"], null):null)))));var count = Math.round((ago / new cljs.core.Keyword(null,"divisor","divisor",2688237584).cljs$core$IFn$_invoke$arity$1(interval)));return [cljs.core.str(count),cljs.core.str(" "),cljs.core.str(new cljs.core.Keyword(null,"unit","unit",1017498870).cljs$core$IFn$_invoke$arity$1(interval)),cljs.core.str(((cljs.core._EQ_.call(null,1,count))?null:"s"))].join('');
});
