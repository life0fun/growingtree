...
cljs.core._add_method.call(null,growingtree_app.commands.handle_maybe_command,"/play",(function (target,activity,state){var controls_ch = cljs.core.get_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var temp__4092__auto___11066 = (function (){var or__3443__auto__ = (function (){var G__11065 = new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(activity);var G__11065__$1 = (((G__11065 == null))?null:clojure.string.split.call(null,G__11065,/ /));var G__11065__$2 = (((G__11065__$1 == null))?null:cljs.core.second.call(null,G__11065__$1));var G__11065__$3 = (((G__11065__$2 == null))?null:cljs.core.first.call(null,cljs.core.re_find.call(null,/http.*\.(mp3|mp4|ogg|wav)/,G__11065__$2)));return G__11065__$3;
...
})();if(cljs.core.truth_(temp__4092__auto___11066))
{var url_11067 = temp__4092__auto___11066;cljs.core.async.put_BANG_.call(null,controls_ch,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"audio-player-source-updated","audio-player-source-updated",2679762480),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [url_11067,new cljs.core.Keyword(null,"selected-channel","selected-channel",2473753411).cljs$core$IFn$_invoke$arity$1(state)], null)], null));
} else
{}
