...
*/
growingtree_app.api.cljsajax.cljs_ajax = (function cljs_ajax(command,nav_path,api_ch,data){var main_path = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652),1], null));var thing_type = cljs.core.last.call(null,main_path);var request = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"handler","handler",1706707644),growingtree_app.api.cljsajax.handler.call(null,command,main_path,api_ch),new cljs.core.Keyword(null,"error-handler","error-handler",1866823671),growingtree_app.api.cljsajax.error_handler.call(null,command,nav_path,api_ch),new cljs.core.Keyword(null,"format","format",4040092521),new cljs.core.Keyword(null,"edn","edn",1014004513),new cljs.core.Keyword(null,"params","params",4313443576),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"thing-type","thing-type",843056171),thing_type,new cljs.core.Keyword(null,"path","path",1017337751),main_path,new cljs.core.Keyword(null,"qpath","qpath",1121695624),cljs.core.get.call(null,nav_path,new cljs.core.Keyword(null,"title","title",1124275658)),new cljs.core.Keyword(null,"details","details",2571625908),data], null),new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY], null);console.log([cljs.core.str("cljs-ajax >>> "),cljs.core.str(command),cljs.core.str(" nav-path "),cljs.core.str(nav_path),cljs.core.str(" data "),cljs.core.str(data)].join(''));
var G__8495 = command;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"add-thing","add-thing",4221519924),G__8495))
{return ajax.core.POST.call(null,[cljs.core.str("/add/"),cljs.core.str(cljs.core.name.call(null,cljs.core.first.call(null,nav_path)))].join(''),request);
} else
