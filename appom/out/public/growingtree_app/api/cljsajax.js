...
return cljs.core.async.put_BANG_.call(null,api_ch,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"api-data","api-data",1934674671),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",1017337751),main_path,new cljs.core.Keyword(null,"things-vec","things-vec",905584254),cljs.core.vec.call(null,things_vec)], null)], null));
} else
{return null;
}
});
...
*/
growingtree_app.api.cljsajax.cljs_ajax = (function cljs_ajax(command,nav_path,api_ch,data){var main_path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(nav_path);var qpath = new cljs.core.Keyword(null,"qpath","qpath",1121695624).cljs$core$IFn$_invoke$arity$1(nav_path);var thing_type = cljs.core.last.call(null,main_path);var request = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"handler","handler",1706707644),growingtree_app.api.cljsajax.handler.call(null,command,main_path,api_ch),new cljs.core.Keyword(null,"error-handler","error-handler",1866823671),growingtree_app.api.cljsajax.error_handler.call(null,command,nav_path,api_ch),new cljs.core.Keyword(null,"format","format",4040092521),new cljs.core.Keyword(null,"edn","edn",1014004513),new cljs.core.Keyword(null,"params","params",4313443576),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"thing-type","thing-type",843056171),thing_type,new cljs.core.Keyword(null,"path","path",1017337751),main_path,new cljs.core.Keyword(null,"qpath","qpath",1121695624),qpath,new cljs.core.Keyword(null,"details","details",2571625908),data], null),new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY], null);console.log([cljs.core.str("cljs-ajax >>> "),cljs.core.str(command),cljs.core.str(" nav-path "),cljs.core.str(nav_path),cljs.core.str(" data "),cljs.core.str(data)].join(''));
