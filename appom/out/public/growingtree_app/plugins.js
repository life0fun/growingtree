...
growingtree_app.plugins.mention = (function mention(name){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.mention","span.mention",-2034584372),name], null)," "], null);
});
...
growingtree_app.plugins.pastie = (function pastie(activity_pieces){
...
growingtree_app.plugins.slash_me = (function slash_me(activity_pieces,current_user_email,users){
...
return cljs.core.assoc_in.call(null,cljs.core.vec.call(null,activity_pieces),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),new cljs.core.Keyword(null,"username","username",1605666410).cljs$core$IFn$_invoke$arity$1(user));
} else {
return activity_pieces;
}
});
...
growingtree_app.plugins.image_embed = (function image_embed(activity_pieces){
return cljs.core.map.call(null,(function (piece){
