...
growingtree_app.plugins.mentions = (function mentions(activity_pieces,current_user_email,users,settings,author){return cljs.core.map.call(null,(function (piece){var vec__12346 = cljs.core.re_find.call(null,/(.*)@(\w+)(.*)/,piece);var _ = cljs.core.nth.call(null,vec__12346,0,null);var pre = cljs.core.nth.call(null,vec__12346,1,null);var username = cljs.core.nth.call(null,vec__12346,2,null);var post = cljs.core.nth.call(null,vec__12346,3,null);var temp__4090__auto__ = (function (){var and__3431__auto__ = typeof piece === 'string';if(and__3431__auto__)
...
growingtree_app.plugins.slash_play = (function slash_play(activity_pieces){var vec__12348 = activity_pieces;var command = cljs.core.nth.call(null,vec__12348,0,null);var url = cljs.core.nth.call(null,vec__12348,1,null);var rest = cljs.core.nthnext.call(null,vec__12348,2);if(cljs.core._EQ_.call(null,command,"/play"))
...
{var vec__12350 = temp__4090__auto__;var _ = cljs.core.nth.call(null,vec__12350,0,null);var pre = cljs.core.nth.call(null,vec__12350,1,null);var r = cljs.core.nth.call(null,vec__12350,2,null);var g = cljs.core.nth.call(null,vec__12350,3,null);var b = cljs.core.nth.call(null,vec__12350,4,null);var post = cljs.core.nth.call(null,vec__12350,5,null);return cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,post),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.color-preview","span.color-preview",4358700844),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",1123684643),{"background-color": [cljs.core.str("rgb("),cljs.core.str(r),cljs.core.str(","),cljs.core.str(g),cljs.core.str(","),cljs.core.str(b),cljs.core.str(")")].join('')}], null)], null)),pre);
} else
{return piece;
}
}),activity_pieces);
...
{var vec__12352 = temp__4090__auto__;var _ = cljs.core.nth.call(null,vec__12352,0,null);var pre = cljs.core.nth.call(null,vec__12352,1,null);var hex = cljs.core.nth.call(null,vec__12352,2,null);var post = cljs.core.nth.call(null,vec__12352,3,null);return cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,post),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.color-preview","span.color-preview",4358700844),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",1123684643),{"background-color": [cljs.core.str("#"),cljs.core.str(hex)].join('')}], null)], null)),pre);
} else
{return piece;
}
}),activity_pieces);
