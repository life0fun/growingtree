...
growingtree_app.components.navbar.thing_nav = (function thing_nav(comm,login_user,thing_listing){
var type = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(thing_listing);
var user_name = new cljs.core.Keyword("person","title","person/title",1791817084).cljs$core$IFn$_invoke$arity$1(login_user);
var login_id = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(login_user);
var options = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pid","pid",1018387698),login_id], null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li.protected","li.protected",-1934045401),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.nav-channel","div.nav-channel",157445526),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.show_channel","a.show_channel",1350918284),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),type,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (type,user_name,login_id,options){
return (function (){
return cljs.core.async.put_BANG_.call(null,comm,growingtree_app.mock_data.all_things_msg_nav_path.call(null,type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pid","pid",1018387698),login_id], null)));
});})(type,user_name,login_id,options))
,new cljs.core.Keyword(null,"class","class",-2030961996),[cljs.core.str("js-"),cljs.core.str(cljs.core.name.call(null,type)),cljs.core.str((cljs.core.truth_(new cljs.core.Keyword(null,"selected","selected",574897764).cljs$core$IFn$_invoke$arity$1(thing_listing))?" active":null))].join('')], null),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(thing_listing)], null),(cljs.core.truth_(cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([type], true),growingtree_app.mock_data.root_add_type))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.fa.fa-plus-square","i.fa.fa-plus-square",1192301467),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (type,user_name,login_id,options){
return (function (){
return cljs.core.async.put_BANG_.call(null,comm,growingtree_app.mock_data.newthing_form_msg_nav_path.call(null,type,options));
});})(type,user_name,login_id,options))
...
growingtree_app.components.navbar.my_thing_nav = (function my_thing_nav(comm,login_user,thing_listing){
var thing_type = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(thing_listing);
var user_name = new cljs.core.Keyword("person","title","person/title",1791817084).cljs$core$IFn$_invoke$arity$1(login_user);
var user_type = new cljs.core.Keyword("person","type","person/type",-1703713807).cljs$core$IFn$_invoke$arity$1(login_user);
var login_id = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(login_user);
var options = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pid","pid",1018387698),login_id], null);
...
return (function (){
return cljs.core.async.put_BANG_.call(null,comm,growingtree_app.mock_data.things_msg_nav_path.call(null,user_type,login_id,thing_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pid","pid",1018387698),login_id], null)));
});})(thing_type,user_name,user_type,login_id,options))
,new cljs.core.Keyword(null,"class","class",-2030961996),[cljs.core.str("js-"),cljs.core.str(cljs.core.name.call(null,thing_type)),cljs.core.str((cljs.core.truth_(new cljs.core.Keyword(null,"selected","selected",574897764).cljs$core$IFn$_invoke$arity$1(thing_listing))?" active":null))].join('')], null),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(thing_listing)], null),(cljs.core.truth_(cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([thing_type], true),growingtree_app.mock_data.root_add_type))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.fa.fa-plus-square","i.fa.fa-plus-square",1192301467),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (thing_type,user_name,user_type,login_id,options){
return (function (){
return cljs.core.async.put_BANG_.call(null,comm,growingtree_app.mock_data.newthing_form_msg_nav_path.call(null,thing_type,options));
});})(thing_type,user_name,user_type,login_id,options))
], null)], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.fa.fa-square","i.fa.fa-square",-1307287996)], null)),(cljs.core.truth_(new cljs.core.Keyword(null,"loading","loading",-737050189).cljs$core$IFn$_invoke$arity$1(thing_listing))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.icon-spinner.icon-spin","i.icon-spinner.icon-spin",2121569380)], null):null)], null)], null);
});
...
var search_box_div = document.querySelector(dommy.core.selector.call(null,[cljs.core.str("#"),cljs.core.str(search_box)].join('')));
var things = cljs.core.vals.call(null,new cljs.core.Keyword(null,"things","things",1255021880).cljs$core$IFn$_invoke$arity$1(self__.state));
var my_things = cljs.core.vals.call(null,new cljs.core.Keyword(null,"my-things","my-things",276171552).cljs$core$IFn$_invoke$arity$1(self__.state));
