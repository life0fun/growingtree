...
growingtree_app.components.navbar.navbar = (function navbar(data,owner,opts){if(typeof growingtree_app.components.navbar.t12131 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.navbar.t12131 = (function (opts,owner,data,navbar,meta12132){
this.opts = opts;
this.owner = owner;
this.data = data;
this.navbar = navbar;
...
growingtree_app.components.navbar.t12131.cljs$lang$type = true;
growingtree_app.components.navbar.t12131.cljs$lang$ctorStr = "growingtree-app.components.navbar/t12131";
growingtree_app.components.navbar.t12131.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"growingtree-app.components.navbar/t12131");
});
growingtree_app.components.navbar.t12131.prototype.om$core$IRender$ = true;
growingtree_app.components.navbar.t12131.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;console.log(cljs.core.pr_str.call(null,"navbar render ",new cljs.core.Keyword(null,"things","things",1255021880).cljs$core$IFn$_invoke$arity$1(self__.data)));
...
return (function (p1__12127_SHARP_){return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"search-form-updated","search-form-updated",-868859534),p1__12127_SHARP_.target.value], null));
});})(comm,settings,this$__$1))
...
growingtree_app.components.navbar.t12131.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.navbar.t12131.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
...
growingtree_app.components.navbar.t12131.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12133){var self__ = this;
var _12133__$1 = this;return self__.meta12132;
});
growingtree_app.components.navbar.t12131.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12133,meta12132__$1){var self__ = this;
var _12133__$1 = this;return (new growingtree_app.components.navbar.t12131(self__.opts,self__.owner,self__.data,self__.navbar,meta12132__$1));
});
growingtree_app.components.navbar.__GT_t12131 = (function __GT_t12131(opts__$1,owner__$1,data__$1,navbar__$1,meta12132){return (new growingtree_app.components.navbar.t12131(opts__$1,owner__$1,data__$1,navbar__$1,meta12132));
});
}
return (new growingtree_app.components.navbar.t12131(opts,owner,data,navbar,null));
});
