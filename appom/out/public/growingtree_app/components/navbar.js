...
growingtree_app.components.navbar.navbar = (function navbar(state,owner,opts){if(typeof growingtree_app.components.navbar.t11912 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.navbar.t11912 = (function (opts,owner,state,navbar,meta11913){
this.opts = opts;
this.owner = owner;
this.state = state;
this.navbar = navbar;
...
growingtree_app.components.navbar.t11912.cljs$lang$type = true;
growingtree_app.components.navbar.t11912.cljs$lang$ctorStr = "growingtree-app.components.navbar/t11912";
growingtree_app.components.navbar.t11912.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"growingtree-app.components.navbar/t11912");
});
growingtree_app.components.navbar.t11912.prototype.om$core$IRender$ = true;
growingtree_app.components.navbar.t11912.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
})),(function (){var attrs11915 = cljs.core.map.call(null,cljs.core.partial.call(null,growingtree_app.components.navbar.thing_nav,comm,login_user),cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"order","order",-1254677256),things));if(cljs.core.map_QMARK_.call(null,attrs11915))
{return React.DOM.ul(sablono.interpreter.attributes.call(null,sablono.util.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["nav-ul"], null)], null),attrs11915)),null);
} else
{return React.DOM.ul({"className": "nav-ul"},sablono.interpreter.interpret.call(null,attrs11915));
}
})(),(function (){var attrs11916 = cljs.core.map.call(null,cljs.core.partial.call(null,growingtree_app.components.navbar.my_thing_nav,comm,login_user),cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"order","order",-1254677256),my_things));if(cljs.core.map_QMARK_.call(null,attrs11916))
{return React.DOM.ul(sablono.interpreter.attributes.call(null,sablono.util.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["nav-ul","my-nav"], null)], null),attrs11916)),null);
} else
{return React.DOM.ul({"className": "nav-ul my-nav"},sablono.interpreter.interpret.call(null,attrs11916));
}
})());
});
growingtree_app.components.navbar.t11912.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.navbar.t11912.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
...
growingtree_app.components.navbar.t11912.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11914){var self__ = this;
var _11914__$1 = this;return self__.meta11913;
});
growingtree_app.components.navbar.t11912.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11914,meta11913__$1){var self__ = this;
var _11914__$1 = this;return (new growingtree_app.components.navbar.t11912(self__.opts,self__.owner,self__.state,self__.navbar,meta11913__$1));
});
growingtree_app.components.navbar.__GT_t11912 = (function __GT_t11912(opts__$1,owner__$1,state__$1,navbar__$1,meta11913){return (new growingtree_app.components.navbar.t11912(opts__$1,owner__$1,state__$1,navbar__$1,meta11913));
});
}
return (new growingtree_app.components.navbar.t11912(opts,owner,state,navbar,null));
});
