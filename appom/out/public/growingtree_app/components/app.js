...
growingtree_app.components.app.app = (function app(app__$1,owner,opts){if(typeof growingtree_app.components.app.t11619 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.app.t11619 = (function (opts,owner,app,meta11620){
this.opts = opts;
this.owner = owner;
this.app = app;
...
growingtree_app.components.app.t11619.cljs$lang$type = true;
growingtree_app.components.app.t11619.cljs$lang$ctorStr = "growingtree-app.components.app/t11619";
growingtree_app.components.app.t11619.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"growingtree-app.components.app/t11619");
});
growingtree_app.components.app.t11619.prototype.om$core$IRender$ = true;
growingtree_app.components.app.t11619.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;var nav_path = growingtree_app.mock_data.get_last_nav_path.call(null,self__.app);var login_user = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"login-user","login-user",1935565562)], null));var error = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",-978969032)], null));var selected_channel = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",1132759174),new cljs.core.Keyword(null,"selected-channel","selected-channel",-366010130).cljs$core$IFn$_invoke$arity$1(self__.app)], null));var current_user = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",-713552705),new cljs.core.Keyword(null,"current-user-email","current-user-email",-1030852599).cljs$core$IFn$_invoke$arity$1(self__.app)], null));var controls_ch = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"controls","controls",1340701452)], null));var open_player_BANG_ = ((function (nav_path,login_user,error,selected_channel,current_user,controls_ch,this$__$1){
...
}catch (e11622){if((e11622 instanceof Error))
{var e = e11622;return growingtree_app.utils.mprint.call(null,"Not edn-compatible: ",path_string);
} else
...
growingtree_app.components.app.t11619.prototype.om$core$IShouldUpdate$ = true;
growingtree_app.components.app.t11619.prototype.om$core$IShouldUpdate$should_update$arity$3 = (function (this$,next_props,next_state){var self__ = this;
...
growingtree_app.components.app.t11619.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.app.t11619.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
...
growingtree_app.components.app.t11619.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11621){var self__ = this;
var _11621__$1 = this;return self__.meta11620;
});
growingtree_app.components.app.t11619.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11621,meta11620__$1){var self__ = this;
var _11621__$1 = this;return (new growingtree_app.components.app.t11619(self__.opts,self__.owner,self__.app,meta11620__$1));
});
growingtree_app.components.app.__GT_t11619 = (function __GT_t11619(opts__$1,owner__$1,app__$2,meta11620){return (new growingtree_app.components.app.t11619(opts__$1,owner__$1,app__$2,meta11620));
});
}
return (new growingtree_app.components.app.t11619(opts,owner,app__$1,null));
});
