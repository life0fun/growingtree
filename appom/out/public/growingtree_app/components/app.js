...
growingtree_app.components.app.app = (function app(app__$1,owner,opts){if(typeof growingtree_app.components.app.t11072 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.app.t11072 = (function (opts,owner,app,meta11073){
this.opts = opts;
this.owner = owner;
this.app = app;
...
growingtree_app.components.app.t11072.cljs$lang$type = true;
growingtree_app.components.app.t11072.cljs$lang$ctorStr = "growingtree-app.components.app/t11072";
growingtree_app.components.app.t11072.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.app/t11072");
});
growingtree_app.components.app.t11072.prototype.om$core$IRender$ = true;
growingtree_app.components.app.t11072.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;var nav_path = cljs.core.last.call(null,cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"nav-path","nav-path",3061255681)], null)));var thing_type = cljs.core.last.call(null,new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(nav_path));var things = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"things","things",4434169015)], null));var nav_path_things = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"nav-path-things","nav-path-things",3876793781),nav_path], null));var selected_channel = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",2446530370),new cljs.core.Keyword(null,"selected-channel","selected-channel",2473753411).cljs$core$IFn$_invoke$arity$1(self__.app)], null));var current_user = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"current-user-email","current-user-email",4091392864).cljs$core$IFn$_invoke$arity$1(self__.app)], null));var controls_ch = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var open_player_BANG_ = ((function (nav_path,thing_type,things,nav_path_things,selected_channel,current_user,controls_ch){
...
});})(nav_path,thing_type,things,nav_path_things,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s))
;var change_inspector_path_BANG_ = ((function (nav_path,thing_type,things,nav_path_things,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_){
...
}catch (e11075){if((e11075 instanceof Error))
{var e = e11075;return growingtree_app.utils.mprint.call(null,"Not edn-compatible: ",path_string);
} else
...
}});})(nav_path,thing_type,things,nav_path_things,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_))
;var persist_local_state_BANG_ = ((function (nav_path,thing_type,things,nav_path_things,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_){
...
});})(nav_path,thing_type,things,nav_path_things,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_))
;var restore_local_state_BANG_ = ((function (nav_path,thing_type,things,nav_path_things,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_,persist_local_state_BANG_){
...
});})(nav_path,thing_type,things,nav_path_things,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_,persist_local_state_BANG_))
;var toggle_inspector_BANG_ = ((function (nav_path,thing_type,things,nav_path_things,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_,persist_local_state_BANG_,restore_local_state_BANG_){
...
});})(nav_path,thing_type,things,nav_path_things,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_,persist_local_state_BANG_,restore_local_state_BANG_))
;var _ = cljs.core.reset_BANG_.call(null,growingtree_app.components.app.keymap,new cljs.core.PersistentArrayMap(null, 7, ["ctrl+slash",open_player_BANG_,"ctrl+esc",toggle_inspector_BANG_,"ctrl+1",change_inspector_path_BANG_,"ctrl+s",persist_local_state_BANG_,"ctrl+r",restore_local_state_BANG_,"slash",focus_search_BANG_,"esc",blur_current_field_BANG_], null));console.log("app state change, re-render all components nav-path ",cljs.core.pr_str.call(null,nav_path)," vec ",nav_path_things);
...
growingtree_app.components.app.t11072.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11074){var self__ = this;
var _11074__$1 = this;return self__.meta11073;
});
growingtree_app.components.app.t11072.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11074,meta11073__$1){var self__ = this;
var _11074__$1 = this;return (new growingtree_app.components.app.t11072(self__.opts,self__.owner,self__.app,meta11073__$1));
});
growingtree_app.components.app.__GT_t11072 = (function __GT_t11072(opts__$1,owner__$1,app__$2,meta11073){return (new growingtree_app.components.app.t11072(opts__$1,owner__$1,app__$2,meta11073));
});
}
return (new growingtree_app.components.app.t11072(opts,owner,app__$1,null));
});
