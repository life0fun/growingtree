...
growingtree_app.components.app.app = (function app(app__$1,owner,opts){if(typeof growingtree_app.components.app.t11348 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.app.t11348 = (function (opts,owner,app,meta11349){
this.opts = opts;
this.owner = owner;
this.app = app;
...
growingtree_app.components.app.t11348.cljs$lang$type = true;
growingtree_app.components.app.t11348.cljs$lang$ctorStr = "growingtree-app.components.app/t11348";
growingtree_app.components.app.t11348.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.app/t11348");
});
growingtree_app.components.app.t11348.prototype.om$core$IRender$ = true;
growingtree_app.components.app.t11348.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;var nav_path = cljs.core.last.call(null,cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"nav-path","nav-path",3061255681)], null)));var thing_type = cljs.core.last.call(null,new cljs.core.Keyword(null,"body","body",1016933652).cljs$core$IFn$_invoke$arity$1(nav_path));var error = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",1110689146)], null));var selected_channel = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",2446530370),new cljs.core.Keyword(null,"selected-channel","selected-channel",2473753411).cljs$core$IFn$_invoke$arity$1(self__.app)], null));var current_user = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"current-user-email","current-user-email",4091392864).cljs$core$IFn$_invoke$arity$1(self__.app)], null));var controls_ch = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var open_player_BANG_ = ((function (nav_path,thing_type,error,selected_channel,current_user,controls_ch){
...
});})(nav_path,thing_type,error,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s))
;var change_inspector_path_BANG_ = ((function (nav_path,thing_type,error,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_){
...
{var e = e11351;return growingtree_app.utils.mprint.call(null,"Not edn-compatible: ",path_string);
} else
...
}});})(nav_path,thing_type,error,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_))
;var persist_local_state_BANG_ = ((function (nav_path,thing_type,error,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_){
...
});})(nav_path,thing_type,error,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_))
;var restore_local_state_BANG_ = ((function (nav_path,thing_type,error,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_,persist_local_state_BANG_){
...
});})(nav_path,thing_type,error,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_,persist_local_state_BANG_))
...
growingtree_app.components.app.t11348.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.app.t11348.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
...
growingtree_app.components.app.t11348.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11350){var self__ = this;
var _11350__$1 = this;return self__.meta11349;
});
growingtree_app.components.app.t11348.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11350,meta11349__$1){var self__ = this;
var _11350__$1 = this;return (new growingtree_app.components.app.t11348(self__.opts,self__.owner,self__.app,meta11349__$1));
});
growingtree_app.components.app.__GT_t11348 = (function __GT_t11348(opts__$1,owner__$1,app__$2,meta11349){return (new growingtree_app.components.app.t11348(opts__$1,owner__$1,app__$2,meta11349));
});
}
return (new growingtree_app.components.app.t11348(opts,owner,app__$1,null));
});
