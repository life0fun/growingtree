...
growingtree_app.components.app.app = (function app(app__$1,owner,opts){if(typeof growingtree_app.components.app.t11253 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.app.t11253 = (function (opts,owner,app,meta11254){
this.opts = opts;
this.owner = owner;
this.app = app;
...
growingtree_app.components.app.t11253.cljs$lang$type = true;
growingtree_app.components.app.t11253.cljs$lang$ctorStr = "growingtree-app.components.app/t11253";
growingtree_app.components.app.t11253.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.app/t11253");
});
growingtree_app.components.app.t11253.prototype.om$core$IRender$ = true;
growingtree_app.components.app.t11253.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
}catch (e11256){if((e11256 instanceof Error))
{var e = e11256;return growingtree_app.utils.mprint.call(null,"Not edn-compatible: ",path_string);
} else
...
;var _ = cljs.core.reset_BANG_.call(null,growingtree_app.components.app.keymap,new cljs.core.PersistentArrayMap(null, 6, ["ctrl+slash",open_player_BANG_,"ctrl+esc",toggle_inspector_BANG_,"ctrl+1",change_inspector_path_BANG_,"ctrl+s",persist_local_state_BANG_,"ctrl+r",restore_local_state_BANG_,"esc",blur_current_field_BANG_], null));console.log("app state change, re-render all ",cljs.core.pr_str.call(null,nav_path));
...
growingtree_app.components.app.t11253.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.app.t11253.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
...
growingtree_app.components.app.t11253.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11255){var self__ = this;
var _11255__$1 = this;return self__.meta11254;
});
growingtree_app.components.app.t11253.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11255,meta11254__$1){var self__ = this;
var _11255__$1 = this;return (new growingtree_app.components.app.t11253(self__.opts,self__.owner,self__.app,meta11254__$1));
});
growingtree_app.components.app.__GT_t11253 = (function __GT_t11253(opts__$1,owner__$1,app__$2,meta11254){return (new growingtree_app.components.app.t11253(opts__$1,owner__$1,app__$2,meta11254));
});
}
return (new growingtree_app.components.app.t11253(opts,owner,app__$1,null));
});
