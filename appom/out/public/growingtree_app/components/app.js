...
growingtree_app.components.app.app = (function app(app__$1,owner,opts){if(typeof growingtree_app.components.app.t11344 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.app.t11344 = (function (opts,owner,app,meta11345){
this.opts = opts;
this.owner = owner;
this.app = app;
...
growingtree_app.components.app.t11344.cljs$lang$type = true;
growingtree_app.components.app.t11344.cljs$lang$ctorStr = "growingtree-app.components.app/t11344";
growingtree_app.components.app.t11344.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.app/t11344");
});
growingtree_app.components.app.t11344.prototype.om$core$IRender$ = true;
growingtree_app.components.app.t11344.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;var nav_path = cljs.core.last.call(null,cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"nav-path","nav-path",3061255681)], null)));var thing_type = cljs.core.last.call(null,new cljs.core.Keyword(null,"body","body",1016933652).cljs$core$IFn$_invoke$arity$1(nav_path));var selected_channel = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",2446530370),new cljs.core.Keyword(null,"selected-channel","selected-channel",2473753411).cljs$core$IFn$_invoke$arity$1(self__.app)], null));var current_user = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"current-user-email","current-user-email",4091392864).cljs$core$IFn$_invoke$arity$1(self__.app)], null));var controls_ch = cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var open_player_BANG_ = ((function (nav_path,thing_type,selected_channel,current_user,controls_ch){
...
});})(nav_path,thing_type,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s))
;var change_inspector_path_BANG_ = ((function (nav_path,thing_type,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_){
...
}catch (e11347){if((e11347 instanceof Error))
{var e = e11347;return growingtree_app.utils.mprint.call(null,"Not edn-compatible: ",path_string);
} else
...
}});})(nav_path,thing_type,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_))
;var persist_local_state_BANG_ = ((function (nav_path,thing_type,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_){
...
});})(nav_path,thing_type,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_))
;var restore_local_state_BANG_ = ((function (nav_path,thing_type,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_,persist_local_state_BANG_){
...
});})(nav_path,thing_type,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_,persist_local_state_BANG_))
;var toggle_inspector_BANG_ = ((function (nav_path,thing_type,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_,persist_local_state_BANG_,restore_local_state_BANG_){
...
});})(nav_path,thing_type,selected_channel,current_user,controls_ch,open_player_BANG_,message_input_focused_QMARK_,search_input_focused_QMARK_,focus_search_BANG_,inspector_path,inspector_path_s,blur_current_field_BANG_,change_inspector_path_BANG_,persist_local_state_BANG_,restore_local_state_BANG_))
;var _ = cljs.core.reset_BANG_.call(null,growingtree_app.components.app.keymap,new cljs.core.PersistentArrayMap(null, 6, ["ctrl+slash",open_player_BANG_,"ctrl+esc",toggle_inspector_BANG_,"ctrl+1",change_inspector_path_BANG_,"ctrl+s",persist_local_state_BANG_,"ctrl+r",restore_local_state_BANG_,"esc",blur_current_field_BANG_], null));console.log("app state change, render nav-path ",cljs.core.pr_str.call(null,nav_path));
...
growingtree_app.components.app.t11344.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11346){var self__ = this;
var _11346__$1 = this;return self__.meta11345;
});
growingtree_app.components.app.t11344.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11346,meta11345__$1){var self__ = this;
var _11346__$1 = this;return (new growingtree_app.components.app.t11344(self__.opts,self__.owner,self__.app,meta11345__$1));
});
growingtree_app.components.app.__GT_t11344 = (function __GT_t11344(opts__$1,owner__$1,app__$2,meta11345){return (new growingtree_app.components.app.t11344(opts__$1,owner__$1,app__$2,meta11345));
});
}
return (new growingtree_app.components.app.t11344(opts,owner,app__$1,null));
});
