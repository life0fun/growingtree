...
growingtree_app.components.main_area.main_area = (function main_area(p__11655,owner,opts){var map__11660 = p__11655;var map__11660__$1 = ((cljs.core.seq_QMARK_.call(null,map__11660))?cljs.core.apply.call(null,cljs.core.hash_map,map__11660):map__11660);var search_filter = cljs.core.get.call(null,map__11660__$1,new cljs.core.Keyword(null,"search-filter","search-filter",674207407));var channel = cljs.core.get.call(null,map__11660__$1,new cljs.core.Keyword(null,"channel","channel",1752854645));var nav_path_things = cljs.core.get.call(null,map__11660__$1,new cljs.core.Keyword(null,"nav-path-things","nav-path-things",3876793781));var nav_path = cljs.core.get.call(null,map__11660__$1,new cljs.core.Keyword(null,"nav-path","nav-path",3061255681));if(typeof growingtree_app.components.main_area.t11661 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.main_area.t11661 = (function (nav_path,nav_path_things,channel,search_filter,map__11660,opts,owner,p__11655,main_area,meta11662){
...
this.opts = opts;
this.owner = owner;
this.p__11655 = p__11655;
this.main_area = main_area;
this.meta11662 = meta11662;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
growingtree_app.components.main_area.t11661.cljs$lang$type = true;
growingtree_app.components.main_area.t11661.cljs$lang$ctorStr = "growingtree-app.components.main-area/t11661";
growingtree_app.components.main_area.t11661.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.main-area/t11661");
});
growingtree_app.components.main_area.t11661.prototype.om$core$IRender$ = true;
growingtree_app.components.main_area.t11661.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
})], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.fa.fa-bars","i.fa.fa-bars",4545900662)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.logo","a.logo",3836741258),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",1017115293),"#/",new cljs.core.Keyword(null,"on-click","on-click",1416542092),cljs.core.constantly.call(null,false)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1014008629),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",1014018390),"images/logo.png",new cljs.core.Keyword(null,"title","title",1124275658),"growingtree-app"], null)], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.container","div.container",4254619350),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#content","div#content",1542434297),growingtree_app.components.main_area.main_content.call(null,self__.nav_path,self__.nav_path_things,self__.search_filter,self__.opts)], null)], null)], null);
})());
});
growingtree_app.components.main_area.t11661.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.main_area.t11661.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return "MainArea";
});
growingtree_app.components.main_area.t11661.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11663){var self__ = this;
var _11663__$1 = this;return self__.meta11662;
});
growingtree_app.components.main_area.t11661.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11663,meta11662__$1){var self__ = this;
var _11663__$1 = this;return (new growingtree_app.components.main_area.t11661(self__.nav_path,self__.nav_path_things,self__.channel,self__.search_filter,self__.map__11660,self__.opts,self__.owner,self__.p__11655,self__.main_area,meta11662__$1));
});
growingtree_app.components.main_area.__GT_t11661 = (function __GT_t11661(nav_path__$1,nav_path_things__$1,channel__$1,search_filter__$1,map__11660__$2,opts__$1,owner__$1,p__11655__$1,main_area__$1,meta11662){return (new growingtree_app.components.main_area.t11661(nav_path__$1,nav_path_things__$1,channel__$1,search_filter__$1,map__11660__$2,opts__$1,owner__$1,p__11655__$1,main_area__$1,meta11662));
});
}
return (new growingtree_app.components.main_area.t11661(nav_path,nav_path_things,channel,search_filter,map__11660__$1,opts,owner,p__11655,main_area,null));
});
...
return (function (p1__11664_SHARP_){return new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(p1__11664_SHARP_).match(re_filter);
...
return (function (p1__11665_SHARP_){var author = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"author","author",3902543101).cljs$core$IFn$_invoke$arity$1(p1__11665_SHARP_)], null));return growingtree_app.components.main_area.thing_entry.call(null,new cljs.core.Keyword(null,"current-user-email","current-user-email",4091392864).cljs$core$IFn$_invoke$arity$1(opts),new cljs.core.Keyword(null,"users","users",1125482874).cljs$core$IFn$_invoke$arity$1(opts),new cljs.core.Keyword(null,"settings","settings",2448535445).cljs$core$IFn$_invoke$arity$1(opts),author,p1__11665_SHARP_);
...
growingtree_app.components.main_area.thing_entry = (function thing_entry(current_user_email,users,settings,author,thing){console.log("thing-entry ",cljs.core.pr_str.call(null,thing),growingtree_app.utils.thing_ident.call(null,thing));
return cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.thing","div.thing",2042067139),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",1013907597),[cljs.core.str("thing-"),cljs.core.str(new cljs.core.Keyword("db","id","db/id",1014111942).cljs$core$IFn$_invoke$arity$1(thing))].join(''),new cljs.core.Keyword(null,"class","class",1108647146),((cljs.core._EQ_.call(null,current_user_email,new cljs.core.Keyword(null,"email","email",1110523662).cljs$core$IFn$_invoke$arity$1(author)))?"current_user":null),new cljs.core.Keyword(null,"key","key",1014010321),new cljs.core.Keyword(null,"created_at","created_at",2383584348).cljs$core$IFn$_invoke$arity$1(thing)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.posted_at","span.posted_at",1306140929),[cljs.core.str(growingtree_app.datetime.time_ago.call(null,new cljs.core.Keyword(null,"created_at","created_at",2383584348).cljs$core$IFn$_invoke$arity$1(thing))),cljs.core.str(" ago")].join('')], null),growingtree_app.utils.gravatar_for.call(null,new cljs.core.Keyword(null,"email","email",1110523662).cljs$core$IFn$_invoke$arity$1(author)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.readable","div.readable",1511467039),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.user","span.user",4620099425),(function (){var or__3443__auto__ = new cljs.core.Keyword(null,"full-name","full-name",3585519227).cljs$core$IFn$_invoke$arity$1(author);if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
{return new cljs.core.Keyword(null,"email","email",1110523662).cljs$core$IFn$_invoke$arity$1(author);
}
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.content","span.content",4256384327),growingtree_app.components.main_area.thing_content.call(null,current_user_email,users,settings,author,thing)], null)], null),cljs.core.map.call(null,(function (media){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.media-entry","div.media-entry",4138135262),media], null);
}),cljs.core.remove.call(null,cljs.core.string_QMARK_,growingtree_app.plugins.vimeo_embed.call(null,growingtree_app.plugins.youtube_embed.call(null,growingtree_app.plugins.image_embed.call(null,clojure.string.split.call(null,new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(thing),growingtree_app.components.main_area.delimiter_re))))))], null));
});
...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",833769449),(function (p1__11666_SHARP_){if(cljs.core._EQ_.call(null,p1__11666_SHARP_.which,13))
...
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-message-updated","user-message-updated",4247565925),p1__11666_SHARP_.target.value], null));
}
