...
growingtree_app.components.main_area.main_area = (function main_area(p__11870,owner,opts){var map__11875 = p__11870;var map__11875__$1 = ((cljs.core.seq_QMARK_.call(null,map__11875))?cljs.core.apply.call(null,cljs.core.hash_map,map__11875):map__11875);var search_filter = cljs.core.get.call(null,map__11875__$1,new cljs.core.Keyword(null,"search-filter","search-filter",674207407));var channel = cljs.core.get.call(null,map__11875__$1,new cljs.core.Keyword(null,"channel","channel",1752854645));var nav_path_things = cljs.core.get.call(null,map__11875__$1,new cljs.core.Keyword(null,"nav-path-things","nav-path-things",3876793781));var nav_path = cljs.core.get.call(null,map__11875__$1,new cljs.core.Keyword(null,"nav-path","nav-path",3061255681));var app = cljs.core.get.call(null,map__11875__$1,new cljs.core.Keyword(null,"app","app",1014001043));if(typeof growingtree_app.components.main_area.t11876 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.main_area.t11876 = (function (main_area,p__11870,app,opts,nav_path_things,nav_path,search_filter,owner,channel,map__11875,meta11877){
...
this.map__11875 = map__11875;
this.meta11877 = meta11877;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
growingtree_app.components.main_area.t11876.cljs$lang$type = true;
growingtree_app.components.main_area.t11876.cljs$lang$ctorStr = "growingtree-app.components.main-area/t11876";
growingtree_app.components.main_area.t11876.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.main-area/t11876");
});
growingtree_app.components.main_area.t11876.prototype.om$core$IRender$ = true;
growingtree_app.components.main_area.t11876.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
growingtree_app.components.main_area.t11876.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.main_area.t11876.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return "MainArea";
});
growingtree_app.components.main_area.t11876.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11878){var self__ = this;
var _11878__$1 = this;return self__.meta11877;
});
growingtree_app.components.main_area.t11876.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11878,meta11877__$1){var self__ = this;
var _11878__$1 = this;return (new growingtree_app.components.main_area.t11876(self__.main_area,self__.p__11870,self__.app,self__.opts,self__.nav_path_things,self__.nav_path,self__.search_filter,self__.owner,self__.channel,self__.map__11875,meta11877__$1));
});
growingtree_app.components.main_area.__GT_t11876 = (function __GT_t11876(main_area__$1,p__11870__$1,app__$1,opts__$1,nav_path_things__$1,nav_path__$1,search_filter__$1,owner__$1,channel__$1,map__11875__$2,meta11877){return (new growingtree_app.components.main_area.t11876(main_area__$1,p__11870__$1,app__$1,opts__$1,nav_path_things__$1,nav_path__$1,search_filter__$1,owner__$1,channel__$1,map__11875__$2,meta11877));
});
}
return (new growingtree_app.components.main_area.t11876(main_area,p__11870,app,opts,nav_path_things,nav_path,search_filter,owner,channel,map__11875__$1,null));
});
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"filter-things","filter-things",3353236652),(function (app,nav_path,nav_path_things,search_filter,opts){var comm = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var thing_type = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652),1,2], null));var add_thing = cljs.core.keyword.call(null,[cljs.core.str("add-"),cljs.core.str(cljs.core.name.call(null,thing_type))].join(''));var title = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"title","title",1124275658)], null));var pid = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",1016980252),new cljs.core.Keyword(null,"pid","pid",1014015229)], null));var override = (function (){var G__11879 = cljs.core.PersistentArrayMap.EMPTY;var G__11879__$1 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11879,growingtree_app.components.entity_view.actionkey_class.call(null,pid,thing_type,"hide")):G__11879);var G__11879__$2 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11879__$1,growingtree_app.components.entity_view.actionkey_class.call(null,pid,add_thing," ")):G__11879__$1);return G__11879__$2;
...
return (function (p1__11880_SHARP_){return new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(p1__11880_SHARP_).match(re_filter);
...
return (function (p1__11881_SHARP_){var author = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"author","author",3902543101).cljs$core$IFn$_invoke$arity$1(p1__11881_SHARP_)], null));return growingtree_app.components.main_area.thing_entry.call(null,app,p1__11881_SHARP_,cljs.core.PersistentArrayMap.EMPTY);
...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",833769449),(function (p1__11882_SHARP_){if(cljs.core._EQ_.call(null,p1__11882_SHARP_.which,13))
...
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-message-updated","user-message-updated",4247565925),p1__11882_SHARP_.target.value], null));
}
