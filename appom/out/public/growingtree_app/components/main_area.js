...
growingtree_app.components.main_area.main_area = (function main_area(p__11252,owner,opts){var map__11257 = p__11252;var map__11257__$1 = ((cljs.core.seq_QMARK_.call(null,map__11257))?cljs.core.apply.call(null,cljs.core.hash_map,map__11257):map__11257);var search_filter = cljs.core.get.call(null,map__11257__$1,new cljs.core.Keyword(null,"search-filter","search-filter",674207407));var channel = cljs.core.get.call(null,map__11257__$1,new cljs.core.Keyword(null,"channel","channel",1752854645));var nav_path_things = cljs.core.get.call(null,map__11257__$1,new cljs.core.Keyword(null,"nav-path-things","nav-path-things",3876793781));var nav_path = cljs.core.get.call(null,map__11257__$1,new cljs.core.Keyword(null,"nav-path","nav-path",3061255681));if(typeof growingtree_app.components.main_area.t11258 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.main_area.t11258 = (function (nav_path,nav_path_things,channel,search_filter,map__11257,opts,owner,p__11252,main_area,meta11259){
...
this.opts = opts;
this.owner = owner;
this.p__11252 = p__11252;
this.main_area = main_area;
this.meta11259 = meta11259;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
growingtree_app.components.main_area.t11258.cljs$lang$type = true;
growingtree_app.components.main_area.t11258.cljs$lang$ctorStr = "growingtree-app.components.main-area/t11258";
growingtree_app.components.main_area.t11258.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.main-area/t11258");
});
growingtree_app.components.main_area.t11258.prototype.om$core$IRender$ = true;
growingtree_app.components.main_area.t11258.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
growingtree_app.components.main_area.t11258.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.main_area.t11258.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return "MainArea";
});
growingtree_app.components.main_area.t11258.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11260){var self__ = this;
var _11260__$1 = this;return self__.meta11259;
});
growingtree_app.components.main_area.t11258.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11260,meta11259__$1){var self__ = this;
var _11260__$1 = this;return (new growingtree_app.components.main_area.t11258(self__.nav_path,self__.nav_path_things,self__.channel,self__.search_filter,self__.map__11257,self__.opts,self__.owner,self__.p__11252,self__.main_area,meta11259__$1));
});
growingtree_app.components.main_area.__GT_t11258 = (function __GT_t11258(nav_path__$1,nav_path_things__$1,channel__$1,search_filter__$1,map__11257__$2,opts__$1,owner__$1,p__11252__$1,main_area__$1,meta11259){return (new growingtree_app.components.main_area.t11258(nav_path__$1,nav_path_things__$1,channel__$1,search_filter__$1,map__11257__$2,opts__$1,owner__$1,p__11252__$1,main_area__$1,meta11259));
});
}
return (new growingtree_app.components.main_area.t11258(nav_path,nav_path_things,channel,search_filter,map__11257__$1,opts,owner,p__11252,main_area,null));
});
growingtree_app.components.main_area.main_content = (function (){var method_table__4301__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var prefer_table__4302__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var method_cache__4303__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var cached_hierarchy__4304__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var hierarchy__4305__auto__ = cljs.core.get.call(null,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",3129050535),cljs.core.get_global_hierarchy.call(null));return (new cljs.core.MultiFn("main-content",(function (nav_path,nav_path_things,search_filter,opts){return cljs.core.first.call(null,new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(nav_path));
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"newthing-form","newthing-form",3991642965),(function (nav_path,nav_path_things,search_filter,opts){console.log("main content newthing-form form ",cljs.core.pr_str.call(null,nav_path));
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"add-thing","add-thing",4221519924),(function (nav_path,nav_path_things,search_filter,opts){console.log("main content submit add-thing ",cljs.core.pr_str.call(null,nav_path));
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"default","default",2558708147),(function (nav_path,nav_path_things,search_filter,opts){console.log("main content default thing listing ",cljs.core.pr_str.call(null,nav_path));
var thing_type = cljs.core.last.call(null,new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(nav_path));return growingtree_app.components.main_area.things_list.call(null,thing_type,nav_path,nav_path_things,search_filter,opts);
}));
growingtree_app.components.main_area.things_list = (function things_list(thing_type,nav_path,nav_path_things,search_filter,opts){console.log("thing-list ",cljs.core.pr_str.call(null,nav_path),cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(nav_path).call(null,nav_path_things)));
...
return (function (p1__11261_SHARP_){return new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(p1__11261_SHARP_).match(re_filter);
});})(comm,things_vec,re_filter))
,things_vec):things_vec);var thing_listing = cljs.core.map.call(null,((function (comm,things_vec,re_filter,filtered_things){
return (function (p1__11262_SHARP_){var author = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"author","author",3902543101).cljs$core$IFn$_invoke$arity$1(p1__11262_SHARP_)], null));return growingtree_app.components.main_area.thing_entry.call(null,opts,p1__11262_SHARP_);
...
growingtree_app.components.main_area.thing_entry = (function thing_entry(opts,thing_data){var thing_type = growingtree_app.utils.thing_ident.call(null,thing_data);return growingtree_app.components.entity_view.thing_entry.call(null,thing_type,thing_data,opts);
});
...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",833769449),(function (p1__11263_SHARP_){if(cljs.core._EQ_.call(null,p1__11263_SHARP_.which,13))
...
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-message-updated","user-message-updated",4247565925),p1__11263_SHARP_.target.value], null));
}
