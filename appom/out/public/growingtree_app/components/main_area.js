...
growingtree_app.components.main_area.main_area = (function main_area(p__11502,owner,opts){var map__11507 = p__11502;var map__11507__$1 = ((cljs.core.seq_QMARK_.call(null,map__11507))?cljs.core.apply.call(null,cljs.core.hash_map,map__11507):map__11507);var search_filter = cljs.core.get.call(null,map__11507__$1,new cljs.core.Keyword(null,"search-filter","search-filter",674207407));var channel = cljs.core.get.call(null,map__11507__$1,new cljs.core.Keyword(null,"channel","channel",1752854645));var nav_path_things = cljs.core.get.call(null,map__11507__$1,new cljs.core.Keyword(null,"nav-path-things","nav-path-things",3876793781));var nav_path = cljs.core.get.call(null,map__11507__$1,new cljs.core.Keyword(null,"nav-path","nav-path",3061255681));var app = cljs.core.get.call(null,map__11507__$1,new cljs.core.Keyword(null,"app","app",1014001043));if(typeof growingtree_app.components.main_area.t11508 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.main_area.t11508 = (function (main_area,app,map__11507,opts,nav_path_things,nav_path,search_filter,owner,channel,p__11502,meta11509){
...
growingtree_app.components.main_area.t11508.cljs$lang$type = true;
growingtree_app.components.main_area.t11508.cljs$lang$ctorStr = "growingtree-app.components.main-area/t11508";
growingtree_app.components.main_area.t11508.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.main-area/t11508");
});
growingtree_app.components.main_area.t11508.prototype.om$core$IRender$ = true;
growingtree_app.components.main_area.t11508.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
growingtree_app.components.main_area.t11508.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.main_area.t11508.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return "MainArea";
});
growingtree_app.components.main_area.t11508.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11510){var self__ = this;
var _11510__$1 = this;return self__.meta11509;
});
growingtree_app.components.main_area.t11508.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11510,meta11509__$1){var self__ = this;
var _11510__$1 = this;return (new growingtree_app.components.main_area.t11508(self__.main_area,self__.app,self__.map__11507,self__.opts,self__.nav_path_things,self__.nav_path,self__.search_filter,self__.owner,self__.channel,self__.p__11502,meta11509__$1));
});
growingtree_app.components.main_area.__GT_t11508 = (function __GT_t11508(main_area__$1,app__$1,map__11507__$2,opts__$1,nav_path_things__$1,nav_path__$1,search_filter__$1,owner__$1,channel__$1,p__11502__$1,meta11509){return (new growingtree_app.components.main_area.t11508(main_area__$1,app__$1,map__11507__$2,opts__$1,nav_path_things__$1,nav_path__$1,search_filter__$1,owner__$1,channel__$1,p__11502__$1,meta11509));
});
}
return (new growingtree_app.components.main_area.t11508(main_area,app,map__11507__$1,opts,nav_path_things,nav_path,search_filter,owner,channel,p__11502,null));
});
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"default","default",2558708147),(function (app,nav_path,nav_path_things,search_filter,opts){console.log("main content default thing listing nav-path ",cljs.core.pr_str.call(null,nav_path));
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"filter-things","filter-things",3353236652),(function (app,nav_path,nav_path_things,search_filter,opts){var comm = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var thing_type = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652),1,2], null));var add_thing = cljs.core.keyword.call(null,[cljs.core.str("add-"),cljs.core.str(cljs.core.name.call(null,thing_type))].join(''));var title = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"title","title",1124275658)], null));var pid = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",1016980252),new cljs.core.Keyword(null,"pid","pid",1014015229)], null));var override = (function (){var G__11511 = cljs.core.PersistentArrayMap.EMPTY;var G__11511__$1 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11511,growingtree_app.components.entity_view.actionkey_class.call(null,pid,thing_type,"hide")):G__11511);var G__11511__$2 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11511__$1,growingtree_app.components.entity_view.actionkey_class.call(null,pid,add_thing," ")):G__11511__$1);return G__11511__$2;
...
growingtree_app.components.main_area.things_list = (function things_list(app,thing_type,nav_path,nav_path_things,search_filter,opts){var comm = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var things_vec = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652)], null));var re_filter = (cljs.core.truth_(search_filter)?(new RegExp(search_filter,"ig")):null);var filtered_things = (cljs.core.truth_(re_filter)?cljs.core.filter.call(null,((function (comm,things_vec,re_filter){
return (function (p1__11512_SHARP_){return new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(p1__11512_SHARP_).match(re_filter);
...
return (function (p1__11513_SHARP_){var author = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"author","author",3902543101).cljs$core$IFn$_invoke$arity$1(p1__11513_SHARP_)], null));return growingtree_app.components.main_area.thing_entry.call(null,app,p1__11513_SHARP_,cljs.core.PersistentArrayMap.EMPTY);
});})(comm,things_vec,re_filter,filtered_things))
,filtered_things);console.log("things body ",cljs.core.pr_str.call(null,things_vec));
console.log("things-list ",cljs.core.pr_str.call(null,thing_type,nav_path,search_filter,things_vec));
...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",833769449),(function (p1__11514_SHARP_){if(cljs.core._EQ_.call(null,p1__11514_SHARP_.which,13))
...
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-message-updated","user-message-updated",4247565925),p1__11514_SHARP_.target.value], null));
}
