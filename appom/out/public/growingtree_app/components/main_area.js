...
growingtree_app.components.main_area.main_area = (function main_area(p__12114,owner,opts){var map__12119 = p__12114;var map__12119__$1 = ((cljs.core.seq_QMARK_.call(null,map__12119))?cljs.core.apply.call(null,cljs.core.hash_map,map__12119):map__12119);var search_filter = cljs.core.get.call(null,map__12119__$1,new cljs.core.Keyword(null,"search-filter","search-filter",274098807));var channel = cljs.core.get.call(null,map__12119__$1,new cljs.core.Keyword(null,"channel","channel",734187692));var nav_path = cljs.core.get.call(null,map__12119__$1,new cljs.core.Keyword(null,"nav-path","nav-path",-444531376));var app = cljs.core.get.call(null,map__12119__$1,new cljs.core.Keyword(null,"app","app",-560961707));if(typeof growingtree_app.components.main_area.t12120 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.main_area.t12120 = (function (app,nav_path,channel,search_filter,map__12119,opts,owner,p__12114,main_area,meta12121){
this.app = app;
...
this.opts = opts;
this.owner = owner;
this.p__12114 = p__12114;
this.main_area = main_area;
this.meta12121 = meta12121;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
growingtree_app.components.main_area.t12120.cljs$lang$type = true;
growingtree_app.components.main_area.t12120.cljs$lang$ctorStr = "growingtree-app.components.main-area/t12120";
growingtree_app.components.main_area.t12120.cljs$lang$ctorPrWriter = ((function (map__12119,map__12119__$1,search_filter,channel,nav_path,app){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"growingtree-app.components.main-area/t12120");
});})(map__12119,map__12119__$1,search_filter,channel,nav_path,app))
;
growingtree_app.components.main_area.t12120.prototype.om$core$IRender$ = true;
growingtree_app.components.main_area.t12120.prototype.om$core$IRender$render$arity$1 = ((function (map__12119,map__12119__$1,search_filter,channel,nav_path,app){
...
;
growingtree_app.components.main_area.t12120.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.main_area.t12120.prototype.om$core$IDisplayName$display_name$arity$1 = ((function (map__12119,map__12119__$1,search_filter,channel,nav_path,app){
return (function (_){var self__ = this;
var ___$1 = this;return "MainArea";
});})(map__12119,map__12119__$1,search_filter,channel,nav_path,app))
;
growingtree_app.components.main_area.t12120.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__12119,map__12119__$1,search_filter,channel,nav_path,app){
return (function (_12122){var self__ = this;
var _12122__$1 = this;return self__.meta12121;
});})(map__12119,map__12119__$1,search_filter,channel,nav_path,app))
;
growingtree_app.components.main_area.t12120.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__12119,map__12119__$1,search_filter,channel,nav_path,app){
return (function (_12122,meta12121__$1){var self__ = this;
var _12122__$1 = this;return (new growingtree_app.components.main_area.t12120(self__.app,self__.nav_path,self__.channel,self__.search_filter,self__.map__12119,self__.opts,self__.owner,self__.p__12114,self__.main_area,meta12121__$1));
});})(map__12119,map__12119__$1,search_filter,channel,nav_path,app))
;
growingtree_app.components.main_area.__GT_t12120 = ((function (map__12119,map__12119__$1,search_filter,channel,nav_path,app){
return (function __GT_t12120(app__$1,nav_path__$1,channel__$1,search_filter__$1,map__12119__$2,opts__$1,owner__$1,p__12114__$1,main_area__$1,meta12121){return (new growingtree_app.components.main_area.t12120(app__$1,nav_path__$1,channel__$1,search_filter__$1,map__12119__$2,opts__$1,owner__$1,p__12114__$1,main_area__$1,meta12121));
});})(map__12119,map__12119__$1,search_filter,channel,nav_path,app))
;
}
return (new growingtree_app.components.main_area.t12120(app,nav_path,channel,search_filter,map__12119__$1,opts,owner,p__12114,main_area,null));
});
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"filter-things","filter-things",-1018039660),(function (app,nav_path,search_filter,opts){var comm = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"controls","controls",1340701452)], null));var thing_type = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",-2049205669),(1),(2)], null));var add_thing = cljs.core.keyword.call(null,("add-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,thing_type))));var join_thing = cljs.core.keyword.call(null,("join-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,thing_type))));var topview = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"top","top",-1856271961)], null));var pid = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"pid","pid",1018387698)], null));var override = (function (){var G__12123 = cljs.core.PersistentArrayMap.EMPTY;var G__12123__$1 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__12123,growingtree_app.components.entity_view.actionkey_class.call(null,pid,thing_type,"hide")):G__12123);var G__12123__$2 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__12123__$1,growingtree_app.components.entity_view.actionkey_class.call(null,pid,add_thing," ")):G__12123__$1);var G__12123__$3 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__12123__$2,growingtree_app.components.entity_view.actionkey_class.call(null,pid,join_thing," ")):G__12123__$2);return G__12123__$3;
...
return (function (p1__12124_SHARP_){return new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(p1__12124_SHARP_).match(re_filter);
...
return (function (p1__12125_SHARP_){var author = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",-713552705),new cljs.core.Keyword(null,"author","author",2111686192).cljs$core$IFn$_invoke$arity$1(p1__12125_SHARP_)], null));return growingtree_app.components.main_area.thing_entry.call(null,app,p1__12125_SHARP_,cljs.core.PersistentArrayMap.EMPTY);
...
growingtree_app.components.main_area.add_thing_forms = (function add_thing_forms(app,nav_path,search_filter,opts){var comm = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"controls","controls",1340701452)], null));var thing_type = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",-2049205669),(1),(2)], null));var topview = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"top","top",-1856271961)], null));var pid = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"pid","pid",1018387698)], null));return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.forms","div.forms",-1775535839),growingtree_app.components.newthing_form.add_form.call(null,new cljs.core.Keyword(null,"add-lecture","add-lecture",-70422632),comm,nav_path),growingtree_app.components.newthing_form.add_form.call(null,new cljs.core.Keyword(null,"add-question","add-question",1475121863),comm,nav_path)], null);
});
...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",884441808),(function (p1__12126_SHARP_){if(cljs.core._EQ_.call(null,p1__12126_SHARP_.which,(13)))
...
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-message-updated","user-message-updated",49302425),p1__12126_SHARP_.target.value], null));
}
