...
growingtree_app.components.main_area.main_area = (function main_area(p__11815,owner,opts){var map__11820 = p__11815;var map__11820__$1 = ((cljs.core.seq_QMARK_.call(null,map__11820))?cljs.core.apply.call(null,cljs.core.hash_map,map__11820):map__11820);var search_filter = cljs.core.get.call(null,map__11820__$1,new cljs.core.Keyword(null,"search-filter","search-filter",274098807));var channel = cljs.core.get.call(null,map__11820__$1,new cljs.core.Keyword(null,"channel","channel",734187692));var nav_path = cljs.core.get.call(null,map__11820__$1,new cljs.core.Keyword(null,"nav-path","nav-path",-444531376));var app = cljs.core.get.call(null,map__11820__$1,new cljs.core.Keyword(null,"app","app",-560961707));if(typeof growingtree_app.components.main_area.t11821 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.main_area.t11821 = (function (app,nav_path,channel,search_filter,map__11820,opts,owner,p__11815,main_area,meta11822){
this.app = app;
this.nav_path = nav_path;
this.channel = channel;
this.search_filter = search_filter;
this.map__11820 = map__11820;
this.opts = opts;
this.owner = owner;
this.p__11815 = p__11815;
this.main_area = main_area;
this.meta11822 = meta11822;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
growingtree_app.components.main_area.t11821.cljs$lang$type = true;
growingtree_app.components.main_area.t11821.cljs$lang$ctorStr = "growingtree-app.components.main-area/t11821";
growingtree_app.components.main_area.t11821.cljs$lang$ctorPrWriter = ((function (map__11820,map__11820__$1,search_filter,channel,nav_path,app){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"growingtree-app.components.main-area/t11821");
});})(map__11820,map__11820__$1,search_filter,channel,nav_path,app))
;
growingtree_app.components.main_area.t11821.prototype.om$core$IRender$ = true;
growingtree_app.components.main_area.t11821.prototype.om$core$IRender$render$arity$1 = ((function (map__11820,map__11820__$1,search_filter,channel,nav_path,app){
...
;
growingtree_app.components.main_area.t11821.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.main_area.t11821.prototype.om$core$IDisplayName$display_name$arity$1 = ((function (map__11820,map__11820__$1,search_filter,channel,nav_path,app){
return (function (_){var self__ = this;
var ___$1 = this;return "MainArea";
});})(map__11820,map__11820__$1,search_filter,channel,nav_path,app))
;
growingtree_app.components.main_area.t11821.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__11820,map__11820__$1,search_filter,channel,nav_path,app){
return (function (_11823){var self__ = this;
var _11823__$1 = this;return self__.meta11822;
});})(map__11820,map__11820__$1,search_filter,channel,nav_path,app))
;
growingtree_app.components.main_area.t11821.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__11820,map__11820__$1,search_filter,channel,nav_path,app){
return (function (_11823,meta11822__$1){var self__ = this;
var _11823__$1 = this;return (new growingtree_app.components.main_area.t11821(self__.app,self__.nav_path,self__.channel,self__.search_filter,self__.map__11820,self__.opts,self__.owner,self__.p__11815,self__.main_area,meta11822__$1));
});})(map__11820,map__11820__$1,search_filter,channel,nav_path,app))
;
growingtree_app.components.main_area.__GT_t11821 = ((function (map__11820,map__11820__$1,search_filter,channel,nav_path,app){
return (function __GT_t11821(app__$1,nav_path__$1,channel__$1,search_filter__$1,map__11820__$2,opts__$1,owner__$1,p__11815__$1,main_area__$1,meta11822){return (new growingtree_app.components.main_area.t11821(app__$1,nav_path__$1,channel__$1,search_filter__$1,map__11820__$2,opts__$1,owner__$1,p__11815__$1,main_area__$1,meta11822));
});})(map__11820,map__11820__$1,search_filter,channel,nav_path,app))
;
}
return (new growingtree_app.components.main_area.t11821(app,nav_path,channel,search_filter,map__11820__$1,opts,owner,p__11815,main_area,null));
});
...
})();var top_entity = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"url-data","url-data",-1539425798),top_eid], null));var add_thing = cljs.core.keyword.call(null,("add-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,thing_type))));var join_thing = cljs.core.keyword.call(null,("join-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,thing_type))));var override = (function (){var G__11824 = cljs.core.PersistentArrayMap.EMPTY;var G__11824__$1 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11824,growingtree_app.components.entity_view.actionkey_class.call(null,pid,thing_type,"hide")):G__11824);var G__11824__$2 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11824__$1,growingtree_app.components.entity_view.actionkey_class.call(null,pid,add_thing," ")):G__11824__$1);var G__11824__$3 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11824__$2,growingtree_app.components.entity_view.actionkey_class.call(null,pid,join_thing," ")):G__11824__$2);return G__11824__$3;
...
return (function (p1__11825_SHARP_){return new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(p1__11825_SHARP_).match(re_filter);
...
growingtree_app.components.main_area.chatbox = (function chatbox(comm,opts){return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.chatbox","div.chatbox",688344411),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a#chat-file-btn.chat-file-btn","a#chat-file-btn.chat-file-btn",-1252138249),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.fa.fa-arrow-circle-o-up","i.fa.fa-arrow-circle-o-up",537659219),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){return cljs.core.async.put_BANG_.call(null,comm,cljs.core.PersistentArrayMap.EMPTY);
})], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.chat-message-form","div.chat-message-form",426674099),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form.message-form","form.message-form",-254024342),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.emo-menu","a.emo-menu",-627275756),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),"https://slack.global.ssl.fastly.net/20655/img/emoji_menu_button.png",new cljs.core.Keyword(null,"width","width",-384071477),"16px;",new cljs.core.Keyword(null,"height","height",1025178622),"16px;"], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea#chat-input.chat-input","textarea#chat-input.chat-input",-5055302),cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-focus","on-focus",-13737624),(function (){return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-message-focused","user-message-focused",311890539)], null));
...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",884441808),(function (p1__11826_SHARP_){if(cljs.core._EQ_.call(null,p1__11826_SHARP_.which,(13)))
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-shoutout","add-shoutout",-1878121948)], null));
} else
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-shoutout","add-shoutout",-1878121948),p1__11826_SHARP_.target.value], null));
}
})], null),(cljs.core.truth_(new cljs.core.Keyword(null,"input-focused?","input-focused?",445310096).cljs$core$IFn$_invoke$arity$1(opts))?null:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"input-value","input-value",-1719954369).cljs$core$IFn$_invoke$arity$1(opts)], null)))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.post","button.post",-1828589430),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-shoutout","add-shoutout",-1878121948)], null));
})], null),"Post"], null)], null)], null)], null);
});
