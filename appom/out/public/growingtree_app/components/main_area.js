...
growingtree_app.components.main_area.main_area = (function main_area(p__11412,owner,opts){var map__11417 = p__11412;var map__11417__$1 = ((cljs.core.seq_QMARK_.call(null,map__11417))?cljs.core.apply.call(null,cljs.core.hash_map,map__11417):map__11417);var search_filter = cljs.core.get.call(null,map__11417__$1,new cljs.core.Keyword(null,"search-filter","search-filter",674207407));var channel = cljs.core.get.call(null,map__11417__$1,new cljs.core.Keyword(null,"channel","channel",1752854645));var nav_path_things = cljs.core.get.call(null,map__11417__$1,new cljs.core.Keyword(null,"nav-path-things","nav-path-things",3876793781));var nav_path = cljs.core.get.call(null,map__11417__$1,new cljs.core.Keyword(null,"nav-path","nav-path",3061255681));var app = cljs.core.get.call(null,map__11417__$1,new cljs.core.Keyword(null,"app","app",1014001043));if(typeof growingtree_app.components.main_area.t11418 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.main_area.t11418 = (function (main_area,app,opts,map__11417,nav_path_things,nav_path,search_filter,owner,p__11412,channel,meta11419){
this.main_area = main_area;
this.app = app;
this.opts = opts;
this.map__11417 = map__11417;
this.nav_path_things = nav_path_things;
this.nav_path = nav_path;
this.search_filter = search_filter;
this.owner = owner;
this.p__11412 = p__11412;
this.channel = channel;
this.meta11419 = meta11419;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
growingtree_app.components.main_area.t11418.cljs$lang$type = true;
growingtree_app.components.main_area.t11418.cljs$lang$ctorStr = "growingtree-app.components.main-area/t11418";
growingtree_app.components.main_area.t11418.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.main-area/t11418");
});
growingtree_app.components.main_area.t11418.prototype.om$core$IRender$ = true;
growingtree_app.components.main_area.t11418.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"default","default",2558708147),(function (app,nav_path,nav_path_things,search_filter,opts){console.log("main content default thing listing ",cljs.core.pr_str.call(null,nav_path));
var thing_type = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652),1,2], null));return growingtree_app.components.main_area.things_list.call(null,app,thing_type,nav_path,nav_path_things,search_filter,opts);
}));
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"filter-things","filter-things",3353236652),(function (app,nav_path,nav_path_things,search_filter){var comm = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var thing_type = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652),1,2], null));var title = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"title","title",1124275658)], null));var pid = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",1016980252),new cljs.core.Keyword(null,"pid","pid",1014015229)], null));var override = (cljs.core.truth_(pid)?growingtree_app.components.entity_view.actionkey_class.call(null,pid,thing_type,"hide"):cljs.core.PersistentArrayMap.EMPTY);console.log("filter-things ",pid,cljs.core.pr_str.call(null,thing_type,override));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1014003715),(cljs.core.truth_(pid)?growingtree_app.components.main_area.thing_entry.call(null,app,title,override):null),(cljs.core.truth_(pid)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"hr","hr",1013907580),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"size","size",1017434995),4], null)], null):null)], null);
}));
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"newthing-form","newthing-form",3991642965),(function (app,nav_path,nav_path_things,search_filter){var comm = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var thing_type = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652),1,1], null));var title = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"title","title",1124275658)], null));var pid = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",1016980252),new cljs.core.Keyword(null,"pid","pid",1014015229)], null));var override = (cljs.core.truth_(pid)?growingtree_app.components.entity_view.actionkey_class.call(null,pid,thing_type,"hide"):cljs.core.PersistentArrayMap.EMPTY);console.log("newthing-form ",pid,cljs.core.pr_str.call(null,thing_type,override));
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"add-thing","add-thing",4221519924),(function (app,nav_path,nav_path_things,search_filter,opts){console.log("main content submit add-thing ",cljs.core.pr_str.call(null,nav_path));
return growingtree_app.components.main_area.things_list.call(null,new cljs.core.Keyword(null,"parent","parent",4313447452),search_filter,opts);
}));
growingtree_app.components.main_area.things_list = (function things_list(app,thing_type,nav_path,nav_path_things,search_filter,opts){var comm = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var things_vec = cljs.core.get.call(null,nav_path_things,cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652),1], null)));var re_filter = (cljs.core.truth_(search_filter)?(new RegExp(search_filter,"ig")):null);var filtered_things = (cljs.core.truth_(re_filter)?cljs.core.filter.call(null,((function (comm,things_vec,re_filter){
return (function (p1__11421_SHARP_){return new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(p1__11421_SHARP_).match(re_filter);
...
return (function (p1__11422_SHARP_){var author = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"author","author",3902543101).cljs$core$IFn$_invoke$arity$1(p1__11422_SHARP_)], null));return growingtree_app.components.main_area.thing_entry.call(null,app,p1__11422_SHARP_,cljs.core.PersistentArrayMap.EMPTY);
});})(comm,things_vec,re_filter,filtered_things))
,filtered_things);return cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.paginated-activities","div.paginated-activities",3824313244),things], null));
});
...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",833769449),(function (p1__11423_SHARP_){if(cljs.core._EQ_.call(null,p1__11423_SHARP_.which,13))
...
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-message-updated","user-message-updated",4247565925),p1__11423_SHARP_.target.value], null));
}
