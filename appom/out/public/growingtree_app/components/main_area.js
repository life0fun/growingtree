...
growingtree_app.components.main_area.main_area = (function main_area(p__11525,owner,opts){var map__11530 = p__11525;var map__11530__$1 = ((cljs.core.seq_QMARK_.call(null,map__11530))?cljs.core.apply.call(null,cljs.core.hash_map,map__11530):map__11530);var search_filter = cljs.core.get.call(null,map__11530__$1,new cljs.core.Keyword(null,"search-filter","search-filter",674207407));var channel = cljs.core.get.call(null,map__11530__$1,new cljs.core.Keyword(null,"channel","channel",1752854645));var nav_path = cljs.core.get.call(null,map__11530__$1,new cljs.core.Keyword(null,"nav-path","nav-path",3061255681));var app = cljs.core.get.call(null,map__11530__$1,new cljs.core.Keyword(null,"app","app",1014001043));if(typeof growingtree_app.components.main_area.t11531 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.main_area.t11531 = (function (app,nav_path,channel,search_filter,map__11530,opts,owner,p__11525,main_area,meta11532){
this.app = app;
this.nav_path = nav_path;
this.channel = channel;
this.search_filter = search_filter;
this.map__11530 = map__11530;
this.opts = opts;
this.owner = owner;
this.p__11525 = p__11525;
this.main_area = main_area;
this.meta11532 = meta11532;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
growingtree_app.components.main_area.t11531.cljs$lang$type = true;
growingtree_app.components.main_area.t11531.cljs$lang$ctorStr = "growingtree-app.components.main-area/t11531";
growingtree_app.components.main_area.t11531.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.main-area/t11531");
});
growingtree_app.components.main_area.t11531.prototype.om$core$IRender$ = true;
growingtree_app.components.main_area.t11531.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
growingtree_app.components.main_area.t11531.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.main_area.t11531.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return "MainArea";
});
growingtree_app.components.main_area.t11531.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11533){var self__ = this;
var _11533__$1 = this;return self__.meta11532;
});
growingtree_app.components.main_area.t11531.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11533,meta11532__$1){var self__ = this;
var _11533__$1 = this;return (new growingtree_app.components.main_area.t11531(self__.app,self__.nav_path,self__.channel,self__.search_filter,self__.map__11530,self__.opts,self__.owner,self__.p__11525,self__.main_area,meta11532__$1));
});
growingtree_app.components.main_area.__GT_t11531 = (function __GT_t11531(app__$1,nav_path__$1,channel__$1,search_filter__$1,map__11530__$2,opts__$1,owner__$1,p__11525__$1,main_area__$1,meta11532){return (new growingtree_app.components.main_area.t11531(app__$1,nav_path__$1,channel__$1,search_filter__$1,map__11530__$2,opts__$1,owner__$1,p__11525__$1,main_area__$1,meta11532));
});
}
return (new growingtree_app.components.main_area.t11531(app,nav_path,channel,search_filter,map__11530__$1,opts,owner,p__11525,main_area,null));
});
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"filter-things","filter-things",3353236652),(function (app,nav_path,search_filter,opts){var comm = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var thing_type = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652),1,2], null));var add_thing = cljs.core.keyword.call(null,[cljs.core.str("add-"),cljs.core.str(cljs.core.name.call(null,thing_type))].join(''));var join_thing = cljs.core.keyword.call(null,[cljs.core.str("join-"),cljs.core.str(cljs.core.name.call(null,thing_type))].join(''));var topview = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"top","top",1014019271)], null));var pid = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",1016980252),new cljs.core.Keyword(null,"pid","pid",1014015229)], null));var override = (function (){var G__11534 = cljs.core.PersistentArrayMap.EMPTY;var G__11534__$1 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11534,growingtree_app.components.entity_view.actionkey_class.call(null,pid,thing_type,"hide")):G__11534);var G__11534__$2 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11534__$1,growingtree_app.components.entity_view.actionkey_class.call(null,pid,add_thing," ")):G__11534__$1);var G__11534__$3 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11534__$2,growingtree_app.components.entity_view.actionkey_class.call(null,pid,join_thing," ")):G__11534__$2);return G__11534__$3;
...
return (function (p1__11535_SHARP_){return new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(p1__11535_SHARP_).match(re_filter);
...
return (function (p1__11536_SHARP_){var author = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"author","author",3902543101).cljs$core$IFn$_invoke$arity$1(p1__11536_SHARP_)], null));return growingtree_app.components.main_area.thing_entry.call(null,app,p1__11536_SHARP_,cljs.core.PersistentArrayMap.EMPTY);
...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",833769449),(function (p1__11537_SHARP_){if(cljs.core._EQ_.call(null,p1__11537_SHARP_.which,13))
...
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-message-updated","user-message-updated",4247565925),p1__11537_SHARP_.target.value], null));
}
