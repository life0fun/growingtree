...
growingtree_app.components.main_area.main_area = (function main_area(p__11419,owner,opts){var map__11424 = p__11419;var map__11424__$1 = ((cljs.core.seq_QMARK_.call(null,map__11424))?cljs.core.apply.call(null,cljs.core.hash_map,map__11424):map__11424);var search_filter = cljs.core.get.call(null,map__11424__$1,new cljs.core.Keyword(null,"search-filter","search-filter",674207407));var channel = cljs.core.get.call(null,map__11424__$1,new cljs.core.Keyword(null,"channel","channel",1752854645));var nav_path_things = cljs.core.get.call(null,map__11424__$1,new cljs.core.Keyword(null,"nav-path-things","nav-path-things",3876793781));var nav_path = cljs.core.get.call(null,map__11424__$1,new cljs.core.Keyword(null,"nav-path","nav-path",3061255681));var app = cljs.core.get.call(null,map__11424__$1,new cljs.core.Keyword(null,"app","app",1014001043));if(typeof growingtree_app.components.main_area.t11425 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.main_area.t11425 = (function (main_area,app,opts,map__11424,nav_path_things,nav_path,search_filter,owner,p__11419,channel,meta11426){
...
growingtree_app.components.main_area.t11425.cljs$lang$type = true;
growingtree_app.components.main_area.t11425.cljs$lang$ctorStr = "growingtree-app.components.main-area/t11425";
growingtree_app.components.main_area.t11425.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.main-area/t11425");
});
growingtree_app.components.main_area.t11425.prototype.om$core$IRender$ = true;
growingtree_app.components.main_area.t11425.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
growingtree_app.components.main_area.t11425.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.main_area.t11425.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return "MainArea";
});
growingtree_app.components.main_area.t11425.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11427){var self__ = this;
var _11427__$1 = this;return self__.meta11426;
});
growingtree_app.components.main_area.t11425.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11427,meta11426__$1){var self__ = this;
var _11427__$1 = this;return (new growingtree_app.components.main_area.t11425(self__.main_area,self__.app,self__.opts,self__.map__11424,self__.nav_path_things,self__.nav_path,self__.search_filter,self__.owner,self__.p__11419,self__.channel,meta11426__$1));
});
growingtree_app.components.main_area.__GT_t11425 = (function __GT_t11425(main_area__$1,app__$1,opts__$1,map__11424__$2,nav_path_things__$1,nav_path__$1,search_filter__$1,owner__$1,p__11419__$1,channel__$1,meta11426){return (new growingtree_app.components.main_area.t11425(main_area__$1,app__$1,opts__$1,map__11424__$2,nav_path_things__$1,nav_path__$1,search_filter__$1,owner__$1,p__11419__$1,channel__$1,meta11426));
});
}
return (new growingtree_app.components.main_area.t11425(main_area,app,opts,map__11424__$1,nav_path_things,nav_path,search_filter,owner,p__11419,channel,null));
});
growingtree_app.components.main_area.main_content = (function (){var method_table__4301__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var prefer_table__4302__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var method_cache__4303__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var cached_hierarchy__4304__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var hierarchy__4305__auto__ = cljs.core.get.call(null,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",3129050535),cljs.core.get_global_hierarchy.call(null));return (new cljs.core.MultiFn("main-content",(function (app,nav_path,nav_path_things,search_filter,opts){if(cljs.core.truth_(new cljs.core.Keyword(null,"body","body",1016933652).cljs$core$IFn$_invoke$arity$1(nav_path)))
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"refresh","refresh",2099349069),(function (app,nav_path,nav_path_things,search_filter,opts){console.log("main content refresh ",cljs.core.pr_str.call(null,nav_path));
var thing_type = cljs.core.get.call(null,nav_path,new cljs.core.Keyword(null,"add-thing","add-thing",4221519924));return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.empty","div.empty",2028370210)], null);
}));
...
cljs.core._add_method.call(null,growingtree_app.components.main_area.main_content,new cljs.core.Keyword(null,"filter-things","filter-things",3353236652),(function (app,nav_path,nav_path_things,search_filter,opts){var comm = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var thing_type = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652),1,2], null));var add_thing = cljs.core.keyword.call(null,[cljs.core.str("add-"),cljs.core.str(cljs.core.name.call(null,thing_type))].join(''));var title = cljs.core.get_in.call(null,app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"title","title",1124275658)], null));var pid = cljs.core.get_in.call(null,nav_path,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",1016980252),new cljs.core.Keyword(null,"pid","pid",1014015229)], null));var override = (function (){var G__11428 = cljs.core.PersistentArrayMap.EMPTY;var G__11428__$1 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11428,growingtree_app.components.entity_view.actionkey_class.call(null,pid,thing_type,"hide")):G__11428);var G__11428__$2 = (cljs.core.truth_(pid)?cljs.core.merge.call(null,G__11428__$1,growingtree_app.components.entity_view.actionkey_class.call(null,pid,add_thing," ")):G__11428__$1);return G__11428__$2;
})();console.log("main-content filter-things ",cljs.core.pr_str.call(null,pid,thing_type,override));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1014003715),(cljs.core.truth_(pid)?growingtree_app.components.main_area.thing_entry.call(null,app,title,override):null),(cljs.core.truth_(pid)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"hr","hr",1013907580),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"size","size",1017434995),4], null)], null):null),growingtree_app.components.main_area.things_list.call(null,app,thing_type,nav_path,nav_path_things,search_filter,opts)], null);
}));
...
return (function (p1__11429_SHARP_){return new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(p1__11429_SHARP_).match(re_filter);
...
return (function (p1__11430_SHARP_){var author = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"author","author",3902543101).cljs$core$IFn$_invoke$arity$1(p1__11430_SHARP_)], null));return growingtree_app.components.main_area.thing_entry.call(null,app,p1__11430_SHARP_,cljs.core.PersistentArrayMap.EMPTY);
...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",833769449),(function (p1__11431_SHARP_){if(cljs.core._EQ_.call(null,p1__11431_SHARP_.which,13))
...
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-message-updated","user-message-updated",4247565925),p1__11431_SHARP_.target.value], null));
}
