...
goog.require('clojure.string');
secretary.core.IRouteMatches = (function (){var obj17386 = {};return obj17386;
})();
...
secretary.core.IRenderRoute = (function (){var obj17388 = {};return obj17388;
})();
...
*/
secretary.core.encode_query_params = (function encode_query_params(query_params){return clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p__17391){var vec__17392 = p__17391;var k = cljs.core.nth.call(null,vec__17392,0,null);var v = cljs.core.nth.call(null,vec__17392,1,null);return [cljs.core.str(cljs.core.name.call(null,k)),cljs.core.str("="),cljs.core.str(secretary.core.encode.call(null,(((v instanceof cljs.core.Keyword))?cljs.core.name.call(null,v):[cljs.core.str(v)].join(''))))].join('');
}),query_params));
});
/**
* Extract a map of query parameters from a query string.
*/
secretary.core.decode_query_params = (function decode_query_params(query_string){return cljs.core.reduce.call(null,(function (m,param){var vec__17394 = clojure.string.split.call(null,param,/=/,2);var k = cljs.core.nth.call(null,vec__17394,0,null);var v = cljs.core.nth.call(null,vec__17394,1,null);var v__$1 = secretary.core.decode.call(null,v);return cljs.core.assoc.call(null,m,k,v__$1);
...
*/
secretary.core.lex_STAR_ = (function lex_STAR_(s,clauses){return cljs.core.some.call(null,(function (p__17398){var vec__17399 = p__17398;var re = cljs.core.nth.call(null,vec__17399,0,null);var action = cljs.core.nth.call(null,vec__17399,1,null);var temp__4092__auto__ = cljs.core.re_find.call(null,re,s);if(cljs.core.truth_(temp__4092__auto__))
{var vec__17400 = temp__4092__auto__;var m = cljs.core.nth.call(null,vec__17400,0,null);var c = cljs.core.nth.call(null,vec__17400,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,s,cljs.core.count.call(null,m)),action.call(null,c)], null);
} else
{return null;
}
}),clauses);
...
{var vec__17403 = secretary.core.lex_STAR_.call(null,s__$1,clauses);var s__$2 = cljs.core.nth.call(null,vec__17403,0,null);var vec__17404 = cljs.core.nth.call(null,vec__17403,1,null);var r = cljs.core.nth.call(null,vec__17404,0,null);var p = cljs.core.nth.call(null,vec__17404,1,null);{
var G__17405 = s__$2;
var G__17406 = [cljs.core.str(pattern),cljs.core.str(r)].join('');
var G__17407 = cljs.core.conj.call(null,params,p);
s__$1 = G__17405;
pattern = G__17406;
params = G__17407;
continue;
...
})], null)], null);var vec__17413 = secretary.core.lex_route.call(null,route,clauses);var re = cljs.core.nth.call(null,vec__17413,0,null);var params = cljs.core.nth.call(null,vec__17413,1,null);if(typeof secretary.core.t17414 !== 'undefined')
{} else
{
/**
* @constructor
*/
secretary.core.t17414 = (function (params,re,vec__17413,clauses,route,compile_route,meta17415){
this.params = params;
this.re = re;
this.vec__17413 = vec__17413;
...
secretary.core.t17414.cljs$lang$type = true;
secretary.core.t17414.cljs$lang$ctorStr = "secretary.core/t17414";
secretary.core.t17414.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"secretary.core/t17414");
});
secretary.core.t17414.prototype.secretary$core$IRouteMatches$ = true;
secretary.core.t17414.prototype.secretary$core$IRouteMatches$route_matches$arity$2 = (function (_,route__$2){var self__ = this;
...
{var vec__17417 = temp__4092__auto__;var ___$2 = cljs.core.nth.call(null,vec__17417,0,null);var ms = cljs.core.nthnext.call(null,vec__17417,1);return cljs.core.merge_with.call(null,cljs.core.vector,cljs.core.PersistentArrayMap.EMPTY,cljs.core.partition.call(null,2,cljs.core.interleave.call(null,self__.params,ms)));
} else
{return null;
}
});
secretary.core.t17414.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17416){var self__ = this;
var _17416__$1 = this;return self__.meta17415;
});
secretary.core.t17414.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17416,meta17415__$1){var self__ = this;
var _17416__$1 = this;return (new secretary.core.t17414(self__.params,self__.re,self__.vec__17413,self__.clauses,self__.route,self__.compile_route,meta17415__$1));
});
secretary.core.__GT_t17414 = (function __GT_t17414(params__$1,re__$1,vec__17413__$1,clauses__$1,route__$1,compile_route__$1,meta17415){return (new secretary.core.t17414(params__$1,re__$1,vec__17413__$1,clauses__$1,route__$1,compile_route__$1,meta17415));
});
}
return (new secretary.core.t17414(params,re,vec__17413,clauses,route,compile_route,null));
});
/**
* @param {...*} var_args
*/
secretary.core.render_route_STAR_ = (function() { 
var render_route_STAR___delegate = function (obj,args){if((function (){var G__17419 = obj;if(G__17419)
{var bit__4093__auto__ = null;if(cljs.core.truth_((function (){var or__3443__auto__ = bit__4093__auto__;if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
{return G__17419.secretary$core$IRenderRoute$;
}
})()))
{return true;
} else
{if((!G__17419.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,secretary.core.IRenderRoute,G__17419);
} else
{return false;
}
}
...
render_route_STAR_.cljs$lang$applyTo = (function (arglist__17420){
var obj = cljs.core.first(arglist__17420);
...
secretary.core.remove_route_BANG_ = (function remove_route_BANG_(obj){return cljs.core.swap_BANG_.call(null,secretary.core._STAR_routes_STAR_,(function (rs){return cljs.core.filterv.call(null,(function (p__17423){var vec__17424 = p__17423;var x = cljs.core.nth.call(null,vec__17424,0,null);var _ = cljs.core.nth.call(null,vec__17424,1,null);return cljs.core.not_EQ_.call(null,x,obj);
}),rs);
}));
});
...
secretary.core.locate_route = (function locate_route(route){return cljs.core.some.call(null,(function (p__17427){var vec__17428 = p__17427;var compiled_route = cljs.core.nth.call(null,vec__17428,0,null);var action = cljs.core.nth.call(null,vec__17428,1,null);var temp__4092__auto__ = secretary.core.route_matches.call(null,compiled_route,route);if(cljs.core.truth_(temp__4092__auto__))
...
*/
secretary.core.dispatch_BANG_ = (function dispatch_BANG_(uri){var vec__17431 = clojure.string.split.call(null,uri,/\?/);var uri_path = cljs.core.nth.call(null,vec__17431,0,null);var query_string = cljs.core.nth.call(null,vec__17431,1,null);var query_params = (cljs.core.truth_(query_string)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"query-params","query-params",1080249757),secretary.core.decode_query_params.call(null,query_string)], null):null);var vec__17432 = secretary.core.locate_route.call(null,uri_path);var action = cljs.core.nth.call(null,vec__17432,0,null);var params = cljs.core.nth.call(null,vec__17432,1,null);var action__$1 = (function (){var or__3443__auto__ = action;if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
...
{var vec__17433 = temp__4092__auto__;var _ = cljs.core.nth.call(null,vec__17433,0,null);var ms = cljs.core.nthnext.call(null,vec__17433,1);return cljs.core.vec.call(null,ms);
} else
{return null;
}
});
...
(secretary.core.render_route["string"] = (function (this$,params){var map__17434 = params;var map__17434__$1 = ((cljs.core.seq_QMARK_.call(null,map__17434))?cljs.core.apply.call(null,cljs.core.hash_map,map__17434):map__17434);var m = map__17434__$1;var query_params = cljs.core.get.call(null,map__17434__$1,new cljs.core.Keyword(null,"query-params","query-params",1080249757));var a = cljs.core.atom.call(null,m);var path = this$.replace((new RegExp(":[^\\s.:*/]+|\\*[^\\s.:*/]*","g")),((function (map__17434,map__17434__$1,m,query_params,a){
...
});})(map__17434,map__17434__$1,m,query_params,a))
