...
sablono.util.ToString = (function (){var obj17505 = {};return obj17505;
})();
...
sablono.util.ToURI = (function (){var obj17507 = {};return obj17507;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__17508){
var xs = cljs.core.seq(arglist__17508);
...
{var vec__17510 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__17510,0,null);var words = cljs.core.nthnext.call(null,vec__17510,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__17511_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__17511_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17511_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__17511_SHARP_))
{return p1__17511_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__17512){
var maps = cljs.core.seq(arglist__17512);
...
*/
sablono.util.normalize_element = (function normalize_element(p__17513){var vec__17516 = p__17513;var tag = cljs.core.nth.call(null,vec__17516,0,null);var content = cljs.core.nthnext.call(null,vec__17516,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__17517 = cljs.core.re_matches.call(null,sablono.util.re_tag,cljs.core.name.call(null,tag));var _ = cljs.core.nth.call(null,vec__17517,0,null);var tag__$1 = cljs.core.nth.call(null,vec__17517,1,null);var id = cljs.core.nth.call(null,vec__17517,2,null);var class$ = cljs.core.nth.call(null,vec__17517,3,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),(cljs.core.truth_(class$)?clojure.string.split.call(null,class$,/\./):null)], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
