...
{{
var G__16647 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16647;
continue;
}
} else
...
{var pred__16651 = cljs.core._EQ_;var expr__16652 = limit;if(cljs.core.truth_(pred__16651.call(null,(1),expr__16652)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16651.call(null,(2),expr__16652)))
...
var G__16654 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16655 = (limit__$1 - (1));
var G__16656 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__16654;
limit__$1 = G__16655;
parts = G__16656;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___16658 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___16658))
{var replacement_16659 = temp__4124__auto___16658;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_16659)));
} else
{buffer.append(ch);
}
{
var G__16660 = (index + (1));
index = G__16660;
continue;
}
}
