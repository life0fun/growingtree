...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_16543 = (0);while(true){
if((i_16543 < arr.length))
{(arr[i_16543] = null);
{
var G__16544 = (i_16543 + (1));
i_16543 = G__16544;
continue;
}
} else
...
{var i_16550 = (self__.level + (1));while(true){
if((i_16550 <= (new_level + (1))))
{(update[i_16550] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_16552 = (0);while(true){
if((i_16552 <= self__.level))
{var links_16553 = (update[i_16552]).forward;if(((links_16553[i_16552]) === x__$1))
{(links_16553[i_16552] = (x__$1.forward[i_16552]));
{
