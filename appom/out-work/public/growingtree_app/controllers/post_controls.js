...
growingtree_app.controllers.post_controls.sendable_message_QMARK_ = (function sendable_message_QMARK_(message){var vec__12233 = clojure.string.split.call(null,message,/ |\n/);var command = cljs.core.nth.call(null,vec__12233,(0),null);var _ = cljs.core.nthnext.call(null,vec__12233,(1));if(cljs.core.truth_((function (){var or__3543__auto__ = cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([command], true),growingtree_app.controllers.post_controls.local_only_commands);if(cljs.core.truth_(or__3543__auto__))
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"playlist-entry-played","playlist-entry-played",1138783655),(function (target,message,p__12235,previous_state,current_state){var vec__12236 = p__12235;var order = cljs.core.nth.call(null,vec__12236,(0),null);var channel_id = cljs.core.nth.call(null,vec__12236,(1),null);var controls_ch = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"controls","controls",1340701452)], null));var playlist = cljs.core.get_in.call(null,current_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",1132759174),channel_id,new cljs.core.Keyword(null,"player","player",-97687400),new cljs.core.Keyword(null,"playlist","playlist",1952276871)], null));var entry = growingtree_app.useful.ffilter.call(null,((function (controls_ch,playlist,vec__12236,order,channel_id){
return (function (p1__12234_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(p1__12234_SHARP_),order);
});})(controls_ch,playlist,vec__12236,order,channel_id))
...
return (function (){var seq__12241 = cljs.core.seq.call(null,players);var chunk__12242 = null;var count__12243 = (0);var i__12244 = (0);while(true){
if((i__12244 < count__12243))
{var player = cljs.core._nth.call(null,chunk__12242,i__12244);player.muted = true;
{
var G__12245 = seq__12241;
var G__12246 = chunk__12242;
var G__12247 = count__12243;
var G__12248 = (i__12244 + (1));
seq__12241 = G__12245;
chunk__12242 = G__12246;
count__12243 = G__12247;
i__12244 = G__12248;
continue;
}
} else
{var temp__4126__auto__ = cljs.core.seq.call(null,seq__12241);if(temp__4126__auto__)
{var seq__12241__$1 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__12241__$1))
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__12241__$1);{
var G__12249 = cljs.core.chunk_rest.call(null,seq__12241__$1);
var G__12250 = c__4299__auto__;
var G__12251 = cljs.core.count.call(null,c__4299__auto__);
var G__12252 = (0);
seq__12241 = G__12249;
chunk__12242 = G__12250;
count__12243 = G__12251;
i__12244 = G__12252;
continue;
}
} else
{var player = cljs.core.first.call(null,seq__12241__$1);player.muted = true;
{
var G__12253 = cljs.core.next.call(null,seq__12241__$1);
var G__12254 = null;
var G__12255 = (0);
var G__12256 = (0);
seq__12241 = G__12253;
chunk__12242 = G__12254;
count__12243 = G__12255;
i__12244 = G__12256;
continue;
}
}
...
return (function (){var seq__12257 = cljs.core.seq.call(null,players);var chunk__12258 = null;var count__12259 = (0);var i__12260 = (0);while(true){
if((i__12260 < count__12259))
{var player = cljs.core._nth.call(null,chunk__12258,i__12260);player.muted = false;
{
var G__12261 = seq__12257;
var G__12262 = chunk__12258;
var G__12263 = count__12259;
var G__12264 = (i__12260 + (1));
seq__12257 = G__12261;
chunk__12258 = G__12262;
count__12259 = G__12263;
i__12260 = G__12264;
continue;
}
} else
{var temp__4126__auto__ = cljs.core.seq.call(null,seq__12257);if(temp__4126__auto__)
{var seq__12257__$1 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__12257__$1))
{var c__4299__auto__ = cljs.core.chunk_first.call(null,seq__12257__$1);{
var G__12265 = cljs.core.chunk_rest.call(null,seq__12257__$1);
var G__12266 = c__4299__auto__;
var G__12267 = cljs.core.count.call(null,c__4299__auto__);
var G__12268 = (0);
seq__12257 = G__12265;
chunk__12258 = G__12266;
count__12259 = G__12267;
i__12260 = G__12268;
continue;
}
} else
{var player = cljs.core.first.call(null,seq__12257__$1);player.muted = false;
{
var G__12269 = cljs.core.next.call(null,seq__12257__$1);
var G__12270 = null;
var G__12271 = (0);
var G__12272 = (0);
seq__12257 = G__12269;
chunk__12258 = G__12270;
count__12259 = G__12271;
i__12260 = G__12272;
continue;
}
}
...
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"current-user-mentioned","current-user-mentioned",134481480),(function (target,message,p__12273,previous_state,current_state){var vec__12274 = p__12273;var activity = cljs.core.nth.call(null,vec__12274,(0),null);var url = cljs.core.nth.call(null,vec__12274,(1),null);var player = dommy.template.__GT_node_like.call(null,target).querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(".audio-player.sfx.audio-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"channel-id","channel-id",138191095).cljs$core$IFn$_invoke$arity$1(activity)))], null)));return setTimeout(((function (player,vec__12274,activity,url){
return (function (){return player.play();
});})(player,vec__12274,activity,url))
,(35));
}));
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"user-logged-out","user-logged-out",-1569726039),(function (target,message,p__12275,previous_state,current_state){var vec__12276 = p__12275;var activity = cljs.core.nth.call(null,vec__12276,(0),null);var url = cljs.core.nth.call(null,vec__12276,(1),null);return growingtree_app.utils.mprint.call(null,"Log the user out somehow");
}));
cljs.core._add_method.call(null,growingtree_app.controllers.post_controls.post_control_event_BANG_,new cljs.core.Keyword(null,"search-field-focused","search-field-focused",1388495290),(function (target,message,p__12277,previous_state,current_state){var vec__12278 = p__12277;var activity = cljs.core.nth.call(null,vec__12278,(0),null);var url = cljs.core.nth.call(null,vec__12278,(1),null);var temp__4126__auto__ = document.querySelector(dommy.core.selector.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [target,new cljs.core.Keyword(null,"input.query","input.query",1777106866)], null)));if(cljs.core.truth_(temp__4126__auto__))
{var search_field = temp__4126__auto__;return window.setTimeout(((function (search_field,temp__4126__auto__,vec__12278,activity,url){
...
});})(search_field,temp__4126__auto__,vec__12278,activity,url))
,(20));
} else
{return null;
}
