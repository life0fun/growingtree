...
growingtree_app.plugins.mentions = (function mentions(activity_pieces,current_user_email,users,settings,author){return cljs.core.map.call(null,(function (piece){var vec__12124 = cljs.core.re_find.call(null,/(.*)@(\w+)(.*)/,piece);var _ = cljs.core.nth.call(null,vec__12124,0,null);var pre = cljs.core.nth.call(null,vec__12124,1,null);var username = cljs.core.nth.call(null,vec__12124,2,null);var post = cljs.core.nth.call(null,vec__12124,3,null);var temp__4090__auto__ = (function (){var and__3431__auto__ = typeof piece === 'string';if(and__3431__auto__)
...
{var at = temp__4090__auto__;return cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,post),growingtree_app.plugins.mention.call(null,username)),pre);
} else
{return piece;
}
}),activity_pieces);
});
growingtree_app.plugins.emoticon = (function emoticon(emoji){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img.emoticon-embed.small","img.emoticon-embed.small",3640115624),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",1014018390),new cljs.core.Keyword(null,"src","src",1014018390).cljs$core$IFn$_invoke$arity$1(emoji),new cljs.core.Keyword(null,"class","class",1108647146),new cljs.core.Keyword(null,"css","css",1014003061).cljs$core$IFn$_invoke$arity$1(emoji),new cljs.core.Keyword(null,"title","title",1124275658),new cljs.core.Keyword(null,"title","title",1124275658).cljs$core$IFn$_invoke$arity$1(emoji)], null)], null);
});
growingtree_app.plugins.links = (function links(activity_pieces){var helper = (function (piece){var temp__4090__auto__ = (function (){var and__3431__auto__ = typeof piece === 'string';if(and__3431__auto__)
...
{var user = cljs.core.get.call(null,users,current_user_email);return cljs.core.assoc_in.call(null,cljs.core.vec.call(null,activity_pieces),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [0], null),new cljs.core.Keyword(null,"username","username",748190792).cljs$core$IFn$_invoke$arity$1(user));
} else
{return activity_pieces;
}
});
growingtree_app.plugins.slash_play = (function slash_play(activity_pieces){var vec__12126 = activity_pieces;var command = cljs.core.nth.call(null,vec__12126,0,null);var url = cljs.core.nth.call(null,vec__12126,1,null);var rest = cljs.core.nthnext.call(null,vec__12126,2);if(cljs.core._EQ_.call(null,command,"/play"))
...
growingtree_app.plugins.rgb_embed = (function rgb_embed(activity_pieces){return cljs.core.map.call(null,(function (piece){var temp__4090__auto__ = cljs.core.re_find.call(null,/(.*)rgb\((\d{1,3}),(\d{1,3}),(\d{1,3})\)(.*)/,piece);if(cljs.core.truth_(temp__4090__auto__))
{var vec__12128 = temp__4090__auto__;var _ = cljs.core.nth.call(null,vec__12128,0,null);var pre = cljs.core.nth.call(null,vec__12128,1,null);var r = cljs.core.nth.call(null,vec__12128,2,null);var g = cljs.core.nth.call(null,vec__12128,3,null);var b = cljs.core.nth.call(null,vec__12128,4,null);var post = cljs.core.nth.call(null,vec__12128,5,null);return cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,post),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.color-preview","span.color-preview",4358700844),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",1123684643),{"background-color": [cljs.core.str("rgb("),cljs.core.str(r),cljs.core.str(","),cljs.core.str(g),cljs.core.str(","),cljs.core.str(b),cljs.core.str(")")].join('')}], null)], null)),pre);
} else
{return piece;
}
}),activity_pieces);
});
growingtree_app.plugins.hex_embed = (function hex_embed(activity_pieces){return cljs.core.map.call(null,(function (piece){var temp__4090__auto__ = cljs.core.re_find.call(null,/(.*)#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})(.*)/,piece);if(cljs.core.truth_(temp__4090__auto__))
{var vec__12130 = temp__4090__auto__;var _ = cljs.core.nth.call(null,vec__12130,0,null);var pre = cljs.core.nth.call(null,vec__12130,1,null);var hex = cljs.core.nth.call(null,vec__12130,2,null);var post = cljs.core.nth.call(null,vec__12130,3,null);return cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,post),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.color-preview","span.color-preview",4358700844),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",1123684643),{"background-color": [cljs.core.str("#"),cljs.core.str(hex)].join('')}], null)], null)),pre);
} else
{return piece;
}
}),activity_pieces);
