...
growingtree_app.components.navbar.navbar = (function navbar(state,owner,opts){if(typeof growingtree_app.components.navbar.t11832 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.navbar.t11832 = (function (opts,owner,state,navbar,meta11833){
this.opts = opts;
this.owner = owner;
this.state = state;
this.navbar = navbar;
...
growingtree_app.components.navbar.t11832.cljs$lang$type = true;
growingtree_app.components.navbar.t11832.cljs$lang$ctorStr = "growingtree-app.components.navbar/t11832";
growingtree_app.components.navbar.t11832.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"growingtree-app.components.navbar/t11832");
});
growingtree_app.components.navbar.t11832.prototype.om$core$IRender$ = true;
growingtree_app.components.navbar.t11832.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;var comm = cljs.core.get_in.call(null,self__.opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",460172477),new cljs.core.Keyword(null,"controls","controls",1340701452)], null));var settings = new cljs.core.Keyword(null,"settings","settings",1556144875).cljs$core$IFn$_invoke$arity$1(self__.state);var login_user = growingtree_app.utils.get_login_user.call(null,self__.state);var search_box = "search-box";var search_box_div = document.querySelector(dommy.core.selector.call(null,("#"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(search_box))));var things = cljs.core.vals.call(null,new cljs.core.Keyword(null,"things","things",1255021880).cljs$core$IFn$_invoke$arity$1(self__.state));var my_things = cljs.core.vals.call(null,new cljs.core.Keyword(null,"my-things","my-things",276171552).cljs$core$IFn$_invoke$arity$1(self__.state));return React.DOM.nav({"className": sablono.util.join_classes.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["nav",(cljs.core.truth_(cljs.core.get_in.call(null,settings,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"forms","forms",2045992350),new cljs.core.Keyword(null,"search","search",1564939822),new cljs.core.Keyword(null,"focused","focused",1851572115)], null)))?"search-focus":null)], null))},React.DOM.form({"className": "search", "action": "/search", "method": "get", "onSubmit": cljs.core.constantly.call(null,false)},sablono.interpreter.input.call(null,{"className": "query", "id": search_box, "name": "query", "type": "text"}),sablono.interpreter.input.call(null,{"className": "submit", "value": "Search", "type": "submit", "onClick": ((function (comm,settings,login_user,search_box,search_box_div,things,my_things,this$__$1){
...
})),(function (){var attrs11835 = cljs.core.map.call(null,cljs.core.partial.call(null,growingtree_app.components.navbar.thing_nav,comm,login_user),cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"order","order",-1254677256),things));if(cljs.core.map_QMARK_.call(null,attrs11835))
{return React.DOM.ul(sablono.interpreter.attributes.call(null,sablono.util.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["nav-ul"], null)], null),attrs11835)),null);
} else
{return React.DOM.ul({"className": "nav-ul"},sablono.interpreter.interpret.call(null,attrs11835));
}
})(),(function (){var attrs11836 = cljs.core.map.call(null,cljs.core.partial.call(null,growingtree_app.components.navbar.my_thing_nav,comm,login_user),cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"order","order",-1254677256),my_things));if(cljs.core.map_QMARK_.call(null,attrs11836))
{return React.DOM.ul(sablono.interpreter.attributes.call(null,sablono.util.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["nav-ul","my-nav"], null)], null),attrs11836)),null);
} else
{return React.DOM.ul({"className": "nav-ul my-nav"},sablono.interpreter.interpret.call(null,attrs11836));
}
})());
});
growingtree_app.components.navbar.t11832.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.navbar.t11832.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
...
growingtree_app.components.navbar.t11832.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11834){var self__ = this;
var _11834__$1 = this;return self__.meta11833;
});
growingtree_app.components.navbar.t11832.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11834,meta11833__$1){var self__ = this;
var _11834__$1 = this;return (new growingtree_app.components.navbar.t11832(self__.opts,self__.owner,self__.state,self__.navbar,meta11833__$1));
});
growingtree_app.components.navbar.__GT_t11832 = (function __GT_t11832(opts__$1,owner__$1,state__$1,navbar__$1,meta11833){return (new growingtree_app.components.navbar.t11832(opts__$1,owner__$1,state__$1,navbar__$1,meta11833));
});
}
return (new growingtree_app.components.navbar.t11832(opts,owner,state,navbar,null));
});
