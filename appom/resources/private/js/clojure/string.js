...
{var pred__25089 = cljs.core._EQ_;var expr__25090 = limit;if(cljs.core.truth_(pred__25089.call(null,1,expr__25090)))
...
{var ch = s.charAt(index);var temp__4090__auto___25096 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___25096))
{var replacement_25097 = temp__4090__auto___25096;buffer.append([cljs.core.str(replacement_25097)].join(''));
} else
{buffer.append(ch);
}
{
