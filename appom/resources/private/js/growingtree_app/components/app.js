...
goog.require('growingtree_app.components.audio_player');
goog.require('ankha.core');
goog.require('cljs.core.async');
goog.require('growingtree_app.components.audio_player');
goog.require('growingtree_app.components.key_queue');
growingtree_app.components.app.keymap = cljs.core.atom.call(null,null);
growingtree_app.components.app.app = (function app(app__$1,owner,opts){if(typeof growingtree_app.components.app.t10983 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.app.t10983 = (function (opts,owner,app,meta10984){
this.opts = opts;
this.owner = owner;
this.app = app;
...
growingtree_app.components.app.t10983.cljs$lang$type = true;
growingtree_app.components.app.t10983.cljs$lang$ctorStr = "growingtree-app.components.app/t10983";
growingtree_app.components.app.t10983.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.app/t10983");
});
growingtree_app.components.app.t10983.prototype.om$core$IRender$ = true;
growingtree_app.components.app.t10983.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
}catch (e10986){if((e10986 instanceof Error))
{var e = e10986;return growingtree_app.utils.mprint.call(null,"Not edn-compatible: ",path_string);
} else
...
})():null)),sablono.interpreter.interpret.call(null,om.core.build.call(null,growingtree_app.components.key_queue.KeyboardHandler,self__.app,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",1017322386),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"keymap","keymap",4174211599),growingtree_app.components.app.keymap,new cljs.core.Keyword(null,"error-ch","error-ch",2409970108),cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"error","error",1110689146)], null))], null)], null))),sablono.interpreter.interpret.call(null,om.core.build_all.call(null,growingtree_app.components.audio_player.player,cljs.core.map.call(null,(function (p__10989){var vec__10990 = p__10989;var channel_id = cljs.core.nth.call(null,vec__10990,0,null);var channel = cljs.core.nth.call(null,vec__10990,1,null);return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"audio-settings","audio-settings",938379180),new cljs.core.Keyword(null,"audio","audio",1107070792).cljs$core$IFn$_invoke$arity$1(self__.app),new cljs.core.Keyword(null,"player","player",4323118675),new cljs.core.Keyword(null,"player","player",4323118675).cljs$core$IFn$_invoke$arity$1(channel),new cljs.core.Keyword(null,"sfx","sfx",1014018039),new cljs.core.Keyword(null,"sfx","sfx",1014018039).cljs$core$IFn$_invoke$arity$1(channel),new cljs.core.Keyword(null,"id","id",1013907597),channel_id], null);
}),new cljs.core.Keyword(null,"channels","channels",2446530370).cljs$core$IFn$_invoke$arity$1(self__.app)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",1017322386),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"comms","comms",1108747865).cljs$core$IFn$_invoke$arity$1(self__.app)], null)], null))),sablono.interpreter.interpret.call(null,om.core.build.call(null,growingtree_app.components.sidebar.sidebar,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"channel","channel",1752854645),selected_channel,new cljs.core.Keyword(null,"settings","settings",2448535445),new cljs.core.Keyword(null,"settings","settings",2448535445).cljs$core$IFn$_invoke$arity$1(self__.app),new cljs.core.Keyword(null,"search-filter","search-filter",674207407),cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",2448535445),new cljs.core.Keyword(null,"forms","forms",1111523233),new cljs.core.Keyword(null,"search","search",4402534682),new cljs.core.Keyword(null,"value","value",1125876963)], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",1017322386),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"comms","comms",1108747865).cljs$core$IFn$_invoke$arity$1(self__.opts),new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"users","users",1125482874).cljs$core$IFn$_invoke$arity$1(self__.app),new cljs.core.Keyword(null,"current-user-email","current-user-email",4091392864),new cljs.core.Keyword(null,"current-user-email","current-user-email",4091392864).cljs$core$IFn$_invoke$arity$1(self__.app),new cljs.core.Keyword(null,"selected-channel","selected-channel",2473753411),new cljs.core.Keyword(null,"selected-channel","selected-channel",2473753411).cljs$core$IFn$_invoke$arity$1(self__.app),new cljs.core.Keyword(null,"channels","channels",2446530370),new cljs.core.Keyword(null,"channels","channels",2446530370).cljs$core$IFn$_invoke$arity$1(self__.app)], null)], null))),sablono.interpreter.interpret.call(null,om.core.build.call(null,growingtree_app.components.main_area.main_area,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"channel","channel",1752854645),selected_channel,new cljs.core.Keyword(null,"search-filter","search-filter",674207407),cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",2448535445),new cljs.core.Keyword(null,"forms","forms",1111523233),new cljs.core.Keyword(null,"search","search",4402534682),new cljs.core.Keyword(null,"value","value",1125876963)], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",1017322386),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"comms","comms",1108747865).cljs$core$IFn$_invoke$arity$1(self__.opts),new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"users","users",1125482874).cljs$core$IFn$_invoke$arity$1(self__.app),new cljs.core.Keyword(null,"current-user-email","current-user-email",4091392864),new cljs.core.Keyword(null,"current-user-email","current-user-email",4091392864).cljs$core$IFn$_invoke$arity$1(self__.app),new cljs.core.Keyword(null,"input-focused?","input-focused?",2338465213),cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",2448535445),new cljs.core.Keyword(null,"forms","forms",1111523233),new cljs.core.Keyword(null,"user-message","user-message",2253309815),new cljs.core.Keyword(null,"focused","focused",4617830121)], null)),new cljs.core.Keyword(null,"input-value","input-value",3916329248),cljs.core.get_in.call(null,self__.app,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",2448535445),new cljs.core.Keyword(null,"forms","forms",1111523233),new cljs.core.Keyword(null,"user-message","user-message",2253309815),new cljs.core.Keyword(null,"value","value",1125876963)], null))], null)], null))),sablono.interpreter.interpret.call(null,om.core.build.call(null,growingtree_app.components.navbar.navbar,cljs.core.select_keys.call(null,self__.app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"channels","channels",2446530370),new cljs.core.Keyword(null,"settings","settings",2448535445)], null)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",1017322386),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"comms","comms",1108747865).cljs$core$IFn$_invoke$arity$1(self__.opts)], null)], null))),React.DOM.div({"className": "at-view", "id": "at-view"},React.DOM.ul({"id": "at-view-ul"})));
});
growingtree_app.components.app.t10983.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.app.t10983.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
...
growingtree_app.components.app.t10983.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10985){var self__ = this;
var _10985__$1 = this;return self__.meta10984;
});
growingtree_app.components.app.t10983.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10985,meta10984__$1){var self__ = this;
var _10985__$1 = this;return (new growingtree_app.components.app.t10983(self__.opts,self__.owner,self__.app,meta10984__$1));
});
growingtree_app.components.app.__GT_t10983 = (function __GT_t10983(opts__$1,owner__$1,app__$2,meta10984){return (new growingtree_app.components.app.t10983(opts__$1,owner__$1,app__$2,meta10984));
});
}
return (new growingtree_app.components.app.t10983(opts,owner,app__$1,null));
});
