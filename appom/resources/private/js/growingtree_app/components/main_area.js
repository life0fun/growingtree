...
growingtree_app.components.main_area.main_area = (function main_area(p__11254,owner,opts){var map__11259 = p__11254;var map__11259__$1 = ((cljs.core.seq_QMARK_.call(null,map__11259))?cljs.core.apply.call(null,cljs.core.hash_map,map__11259):map__11259);var search_filter = cljs.core.get.call(null,map__11259__$1,new cljs.core.Keyword(null,"search-filter","search-filter",674207407));var channel = cljs.core.get.call(null,map__11259__$1,new cljs.core.Keyword(null,"channel","channel",1752854645));var nav_path_things = cljs.core.get.call(null,map__11259__$1,new cljs.core.Keyword(null,"nav-path-things","nav-path-things",3876793781));var nav_path = cljs.core.get.call(null,map__11259__$1,new cljs.core.Keyword(null,"nav-path","nav-path",3061255681));var app = cljs.core.get.call(null,map__11259__$1,new cljs.core.Keyword(null,"app","app",1014001043));if(typeof growingtree_app.components.main_area.t11260 !== 'undefined')
{} else
{
/**
* @constructor
*/
growingtree_app.components.main_area.t11260 = (function (main_area,app,opts,nav_path_things,map__11259,p__11254,nav_path,search_filter,owner,channel,meta11261){
this.main_area = main_area;
this.app = app;
this.opts = opts;
this.nav_path_things = nav_path_things;
this.map__11259 = map__11259;
this.p__11254 = p__11254;
...
growingtree_app.components.main_area.t11260.cljs$lang$type = true;
growingtree_app.components.main_area.t11260.cljs$lang$ctorStr = "growingtree-app.components.main-area/t11260";
growingtree_app.components.main_area.t11260.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"growingtree-app.components.main-area/t11260");
});
growingtree_app.components.main_area.t11260.prototype.om$core$IRender$ = true;
growingtree_app.components.main_area.t11260.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
growingtree_app.components.main_area.t11260.prototype.om$core$IDisplayName$ = true;
growingtree_app.components.main_area.t11260.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return "MainArea";
});
growingtree_app.components.main_area.t11260.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11262){var self__ = this;
var _11262__$1 = this;return self__.meta11261;
});
growingtree_app.components.main_area.t11260.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11262,meta11261__$1){var self__ = this;
var _11262__$1 = this;return (new growingtree_app.components.main_area.t11260(self__.main_area,self__.app,self__.opts,self__.nav_path_things,self__.map__11259,self__.p__11254,self__.nav_path,self__.search_filter,self__.owner,self__.channel,meta11261__$1));
});
growingtree_app.components.main_area.__GT_t11260 = (function __GT_t11260(main_area__$1,app__$1,opts__$1,nav_path_things__$1,map__11259__$2,p__11254__$1,nav_path__$1,search_filter__$1,owner__$1,channel__$1,meta11261){return (new growingtree_app.components.main_area.t11260(main_area__$1,app__$1,opts__$1,nav_path_things__$1,map__11259__$2,p__11254__$1,nav_path__$1,search_filter__$1,owner__$1,channel__$1,meta11261));
});
}
return (new growingtree_app.components.main_area.t11260(main_area,app,opts,nav_path_things,map__11259__$1,p__11254,nav_path,search_filter,owner,channel,null));
});
...
return (function (p1__11263_SHARP_){return new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(p1__11263_SHARP_).match(re_filter);
...
return (function (p1__11264_SHARP_){var author = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"author","author",3902543101).cljs$core$IFn$_invoke$arity$1(p1__11264_SHARP_)], null));return growingtree_app.components.main_area.thing_entry.call(null,app,p1__11264_SHARP_,cljs.core.PersistentArrayMap.EMPTY);
...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",833769449),(function (p1__11265_SHARP_){if(cljs.core._EQ_.call(null,p1__11265_SHARP_.which,13))
...
{return cljs.core.async.put_BANG_.call(null,comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-message-updated","user-message-updated",4247565925),p1__11265_SHARP_.target.value], null));
}
