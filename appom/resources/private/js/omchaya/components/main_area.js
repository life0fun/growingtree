...
}),new cljs.core.Keyword(null,"on-key-up","on-key-up",833769449),(function (p1__22609_SHARP_){if(cljs.core._EQ_.call(null,p1__22609_SHARP_.which,13))
...
omchaya.components.main_area.activities_list = (function activities_list(filtered_activities,opts){return cljs.core.map.call(null,(function (p1__22610_SHARP_){var author = cljs.core.get_in.call(null,opts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"users","users",1125482874),new cljs.core.Keyword(null,"author","author",3902543101).cljs$core$IFn$_invoke$arity$1(p1__22610_SHARP_)], null));return omchaya.components.main_area.activity_entry.call(null,new cljs.core.Keyword(null,"current-user-email","current-user-email",4091392864).cljs$core$IFn$_invoke$arity$1(opts),new cljs.core.Keyword(null,"users","users",1125482874).cljs$core$IFn$_invoke$arity$1(opts),new cljs.core.Keyword(null,"settings","settings",2448535445).cljs$core$IFn$_invoke$arity$1(opts),author,p1__22610_SHARP_);
}),filtered_activities);
});
omchaya.components.main_area.main_area = (function main_area(p__22612,owner,opts){var map__22617 = p__22612;var map__22617__$1 = ((cljs.core.seq_QMARK_.call(null,map__22617))?cljs.core.apply.call(null,cljs.core.hash_map,map__22617):map__22617);var search_filter = cljs.core.get.call(null,map__22617__$1,new cljs.core.Keyword(null,"search-filter","search-filter",674207407));var channel = cljs.core.get.call(null,map__22617__$1,new cljs.core.Keyword(null,"channel","channel",1752854645));if(typeof omchaya.components.main_area.t22618 !== 'undefined')
{} else
{
/**
* @constructor
...
omchaya.components.main_area.t22618.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"omchaya.components.main-area/t22618");
});
omchaya.components.main_area.t22618.prototype.om$core$IRender$ = true;
omchaya.components.main_area.t22618.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
...
return (function (p1__22611_SHARP_){return new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(p1__22611_SHARP_).match(re_filter);
...
omchaya.components.main_area.t22618.prototype.om$core$IDisplayName$display_name$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return "MainArea";
});
omchaya.components.main_area.t22618.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22620){var self__ = this;
var _22620__$1 = this;return self__.meta22619;
});
omchaya.components.main_area.t22618.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22620,meta22619__$1){var self__ = this;
var _22620__$1 = this;return (new omchaya.components.main_area.t22618(self__.channel,self__.search_filter,self__.map__22617,self__.opts,self__.owner,self__.p__22612,self__.main_area,meta22619__$1));
});
omchaya.components.main_area.__GT_t22618 = (function __GT_t22618(channel__$1,search_filter__$1,map__22617__$2,opts__$1,owner__$1,p__22612__$1,main_area__$1,meta22619){return (new omchaya.components.main_area.t22618(channel__$1,search_filter__$1,map__22617__$2,opts__$1,owner__$1,p__22612__$1,main_area__$1,meta22619));
});
}
