...
{return omchaya.useful.ffilter.call(null,(function (piece){var vec__22709 = cljs.core.re_find.call(null,/(.*)@(\w+)(.*)/,piece);var _ = cljs.core.nth.call(null,vec__22709,0,null);var pre = cljs.core.nth.call(null,vec__22709,1,null);var username = cljs.core.nth.call(null,vec__22709,2,null);var post = cljs.core.nth.call(null,vec__22709,3,null);return cljs.core._EQ_.call(null,username,new cljs.core.Keyword(null,"username","username",748190792).cljs$core$IFn$_invoke$arity$1(current_user));
...
cljs.core._add_method.call(null,omchaya.controllers.post_api.post_api_event_BANG_,new cljs.core.Keyword(null,"default","default",2558708147),(function (target,message,previous_state,current_state){return omchaya.utils.mprint.call(null,"No post-api handler for: ",message);
}));
