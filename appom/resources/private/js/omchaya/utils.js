...
var mprint__delegate = function (message){if(cljs.core.truth_(omchaya.utils.logging_enabled_QMARK_))
...
;
omchaya.utils.safe_sel = (function safe_sel(s){return [cljs.core.str(clojure.string.replace.call(null,clojure.string.lower_case.call(null,[cljs.core.str(s)].join('')),/[\W]/,"-"))].join('');
});
omchaya.utils.email__GT_gravatar_url = (function email__GT_gravatar_url(email){var email__$1 = (function (){var or__3443__auto__ = email;if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
{return "unknown-email@unknown-domain.com";
}
})();var container = (function (){var G__23853 = (new goog.crypt.Md5());G__23853.update(email__$1);
return G__23853;
...
var ajax__delegate = function (url,method,data_string,success,p__23855){var vec__23857 = p__23855;var error = cljs.core.nth.call(null,vec__23857,0,null);var headers = cljs.core.nth.call(null,vec__23857,1,null);var request = (new goog.net.XhrIo());var d = (new goog.async.Deferred());var listener_id = goog.events.listen(request,goog.net.EventType.COMPLETE,((function (request,d){
...
{d.addCallback((function (p1__23854_SHARP_){return success.call(null,cljs.core.js__GT_clj.call(null,p1__23854_SHARP_,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",4191781672),true));
}));
} else
{}
...
var p__23855 = null;if (arguments.length > 4) {
